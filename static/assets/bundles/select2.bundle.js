					...
					if ((this.clear(), 0 !== e.length)) {
						for (
							...
							l && o.attr('title', l),
								...
								(l = o.find('.select2-selection__choice__remove')).attr('title', r()),
								l.attr('aria-label', r()),
			...
			return (
				...
				(e.prototype.tokenizer = function (e, t, n, s) {
					for (
						...
						var l = o[r];
						-1 !== i.indexOf(l) &&
						((l = o.substr(0, r)), null != (l = a(c.extend({}, t, { term: l }))))
			...
			return (
				...
				(e.prototype._positionDropdown = function () {
					var e = u(window),
						...
						r = ((o.top = i.top), (o.bottom = i.top + o.height), this.$dropdown.outerHeight(!1)),
						a = e.scrollTop(),
		...
		u.define('select2/core', ['jquery', './options', './utils', './keys'], function (t, i, o, s) {
			...
			return (
				...
				(r.prototype._resolveWidth = function (e, t) {
					var n,
						s = /^width:(([-+]?([0-9]*\.)?[0-9]+)(px|em|ex|%|in|cm|mm|pt|pc))/i;
					if ('resolve' == t)
				...
				(r.prototype.trigger = function (e, t) {
					...
					if (
						(void 0 === t && (t = {}), e in s) &&
						(n.call(this, s[e], (s = { prevented: !1, name: e, args: t })), s.prevented)
					)
		...
		(a = function (c) {
			...
			var h = (c.event.special.mousewheel = {
				...
				getLineHeight: function (e) {
					var t = c(e);
					return (
						(e = t['offsetParent' in c.fn ? 'offsetParent' : 'parent']()).length || (e = c('body')),
			...
			function s(e) {
				...
				if (
					...
					return (
						1 === n.deltaMode
							? ((i *= t = c.data(this, 'mousewheel-line-height')), (r *= t), (o *= t))
							: 2 === n.deltaMode &&
								((i *= t = c.data(this, 'mousewheel-page-height')), (r *= t), (o *= t)),
