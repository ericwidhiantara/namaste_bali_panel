!(function (l, e) {
	'object' == typeof exports && 'undefined' != typeof module
		...
		: 'function' == typeof define && define.amd
			? define(e)
			: ((l = 'undefined' != typeof globalThis ? globalThis : l || self).jsVectorMap = e());
})(this, function () {
	'use strict';
	function l(l, e) {
		(l.prototype = Object.create(e.prototype)), t((l.prototype.constructor = l), e);
	}
	function t(l, e) {
		...
		Object.assign ||
			Object.defineProperty(Object, 'assign', {
				...
				value: function (l) {
					...
					for (var e = Object(l), t = 1; t < arguments.length; t++)
						if (null != (a = arguments[t]))
							for (var a = Object(a), n = Object.keys(Object(a)), i = 0, s = n.length; i < s; i++) {
								var r = n[i],
									o = Object.getOwnPropertyDescriptor(a, r);
								void 0 !== o && o.enumerable && (e[r] = a[r]);
							}
					return e;
				}
			});
	var B = function (l) {
			return !(
				!l ||
				'object' != typeof l ||
				((l = l), '[object RegExp]' === (e = Object.prototype.toString.call(l))) ||
				'[object Date]' === e ||
				l instanceof Node ||
				l.$$typeof === O
			);
	...
	function r(l, e) {
		return !1 !== e.clone && e.isMergeableObject(l) ? u(Array.isArray(l) ? [] : {}, l, e) : l;
	}
	function I(l, e, t) {
		...
		return Object.keys(l).concat(
			...
			Object.getOwnPropertySymbols
				? Object.getOwnPropertySymbols(e).filter(function (l) {
						return e.propertyIsEnumerable(l);
					})
				: [])
		);
		var e;
	...
	function Y(a, n, i) {
		var s = {};
		return (
			i.isMergeableObject(a) &&
				e(a).forEach(function (l) {
					s[l] = r(a[l], i);
				}),
			e(n).forEach(function (l) {
				...
				(!o((e = a), (t = l)) ||
					...
					(o(a, l) && i.isMergeableObject(n[l])
						? (s[l] = ((e = i).customMerge && 'function' == typeof (e = e.customMerge(l)) ? e : u)(
								a[l],
								n[l],
								i
							))
	...
	function p(l, e, t) {
		return (t = void 0 === t ? !1 : t) ? u(l, e) : Object.assign(l, e);
	}
	function m(l, e) {
	...
	function M(l, e, t) {
		var a = -1 === (e = i(e)).getAttribute('class').indexOf('jvm-region') ? 'marker' : 'region',
			n = 'region' == a,
			e = n ? e.getAttribute('data-code') : e.getAttribute('data-index');
		return {
			type: a,
			code: e,
			event: t
				? n
					? f.onRegionTooltipShow
					: f.onMarkerTooltipShow
				: n
					? f.onRegionSelected
					: f.onMarkerSelected,
			element: (n ? l.regions : l._markers)[e].element,
			tooltipText: n ? l._mapData.paths[e].name || '' : l._markers[e].config.name || ''
		};
	}
	var D,
		u = function (l, e, t) {
			((t = t || {}).arrayMerge = t.arrayMerge || I),
				(t.isMergeableObject = t.isMergeableObject || B),
				(t.cloneUnlessOtherwiseSpecified = r);
			var a = Array.isArray(e);
			return a === Array.isArray(l) ? (a ? t.arrayMerge(l, e, t) : Y(l, e, t)) : r(e, t);
		},
		Z = {},
		z = 1,
		d = {
			on: function (l, e, t, a) {
				void 0 === a && (a = {});
				var n = 'jvm:' + e + '::' + z++;
				(Z[n] = { selector: l, handler: t }), (t._uid = n), l.addEventListener(e, t, a);
			},
			delegate: function (e, l, t, a) {
				(l = l.split(' ')).forEach(function (l) {
					d.on(e, l, function (l) {
						var e = l.target;
						e.matches(t) && a.call(e, l);
					});
				});
			},
			off: function (l, e, t) {
				e = e.split(':')[1];
				l.removeEventListener(e, t), delete Z[t._uid];
			},
			flush: function () {
				Object.keys(Z).forEach(function (l) {
					d.off(Z[l].selector, l, Z[l].handler);
				});
			},
		...
		g =
			((X.prototype.dispose = function () {
				this._tooltip ? s(this._tooltip) : this.shape.remove();
				for (
					var l,
						e = (function (l, e) {
							var t,
								a = ('undefined' != typeof Symbol && l[Symbol.iterator]) || l['@@iterator'];
							...
							if (
								...
								(a = (function (l) {
									...
									if (l)
										return 'string' == typeof l
											...
											: 'Map' ===
														(e =
															'Object' === (e = Object.prototype.toString.call(l).slice(8, -1)) &&
															l.constructor
																? l.constructor.name
																: e) || 'Set' === e
												? Array.from(l)
								...
								(e && l && 'number' == typeof l.length)
							)
								return (
									a && (l = a),
									(t = 0),
									function () {
										return t >= l.length ? { done: !0 } : { done: !1, value: l[t++] };
									}
								);
							throw new TypeError(
		...
		N =
			(l(y, (D = g)),
			((C = y.prototype)._createRegion = function (l, e, t) {
				return (
					(l = this._map.canvas.createPath({ d: l, dataCode: e }, t)).addClass(
						'jvm-region jvm-element'
					),
					l
				);
			}),
			(C.updateLabelPosition = function () {
				this.label &&
					this.label.set({
	...
	function y(l) {
		var e,
			...
			l = l.labelsGroup,
			t =
				(((e = D.call(this) || this)._map = t),
				(e.shape = e._createRegion(n, a, i)),
				e.getLabelText(a, s));
		return (
			s &&
				t &&
				((n = e.shape.getBBox()),
				(i = e.getLabelOffsets(a, s)),
				(e.labelX = n.x + n.width / 2 + i[0]),
				(e.labelY = n.y + n.height / 2 + i[1]),
	...
	c(N, _);
	l(v, (H = g)),
		(v.prototype.setStyle = function (l, e) {
			this.shape.setStyle(l, e);
		});
	var H,
		K = v;
	function v(l) {
		var e,
			...
			l = l.config;
		return (
			((e = H.call(this) || this).config = l),
			(e.shape = a.canvas.createLine({ x1: i, y1: s, x2: r, y2: o, dataIndex: t }, n, h)),
			e.shape.addClass('jvm-line'),
			e
		);
	}
	l(b, (U = g)),
		((C = b.prototype).updateLabelPosition = function () {
			this.label &&
				this.label.set({
					x:
		...
		(C._createLabel = function (l) {
			var e = l.index,
				...
				s = l.cy,
				r = l.marker,
				l = l.isRecentlyCreated,
				o = this.getLabelText(e, a);
			(this._labelX = i / t.scale - t.transX),
				(this._labelY = s / t.scale - t.transY),
				(this._offsets = l && r.offsets ? r.offsets : this.getLabelOffsets(e, a)),
				(this.label = t.canvas.createText(
					{ text: o, dataIndex: e, x: this._labelX, y: this._labelY, dy: '0.6ex' },
					t.params.markerLabelStyle,
					n
				)),
				this.label.addClass('jvm-marker jvm-element'),
				l && this.updateLabelPosition();
		});
	var U,
		V = b;
	function b(l) {
		var e,
			...
			o = l.group;
		return (
			((e = U.call(this) || this)._map = r),
			(e._isImage = !!a.initial.image),
			(e.config = l),
			(e.shape = r.canvas[e._isImage ? 'createImage' : 'createCircle'](
				{ dataIndex: t, cx: i, cy: s },
				a,
				o
			)),
	...
	$.prototype.render = function () {
		var l,
			e,
			t = this._series.scale.getTicks(),
			a = h('div', 'jvm-legend-inner');
		(this._body.innderHTML = ''),
			this._options.title &&
				((e = h('div', 'jvm-legend-title', this._options.title)), this._body.appendChild(e)),
			this._body.appendChild(a);
		for (var n = 0; n < t.length; n++) {
			var i = h('div', 'jvm-legend-tick'),
				s = h('div', 'jvm-legend-tick-sample');
			switch (this._series.config.attribute) {
				case 'fill':
					(l = t[n].value),
						/\.(jpg|gif|png)$/.test(l)
							? (s.style.background = 'url(' + t[n].value + ')')
							: (s.style.background = t[n].value);
					break;
				case 'stroke':
					s.style.background = t[n].value;
					break;
				case 'image':
					(s.style.background =
						'url(' +
						('object' == typeof t[n].value ? t[n].value.url : t[n].value) +
			...
			var r = t[n].label,
				r =
					...
					h('div', 'jvm-legend-tick-text', r));
			i.appendChild(r), a.appendChild(i);
		}
	};
	var F = $,
		W =
			(((C = Q.prototype).getValue = function (l) {
				return this._scale[l];
			}),
			(C.getTicks = function () {
				var l,
					e = [];
				for (l in this._scale) e.push({ label: l, value: this._scale[l] });
				return e;
			}),
			Q),
		J =
			(((_ = q.prototype).setValues = function (l) {
				var e,
					t = {};
				for (e in l) l[e] && (t[e] = this.scale.getValue(l[e]));
				this.setAttributes(t);
			}),
			(_.setAttributes = function (l) {
				for (var e in l)
					this._elements[e] && this._elements[e].element.setStyle(this.config.attribute, l[e]);
			}),
			(_.clear = function () {
				var l,
					e = {};
				for (l in this._values)
					this._elements[l] &&
						(e[l] = this._elements[l].element.shape.style.initial[this.config.attribute]);
	...
	function q(l, e, t) {
		void 0 === l && (l = {}),
			...
			'object' == typeof l.scale && (this.scale = new W(l.scale)),
			this.config.legend &&
				(this.legend = new F(p({ map: this._map, series: this }, this.config.legend))),
	...
	function $(l) {
		(this._options = l = void 0 === l ? {} : l),
			(this._map = this._options.map),
			(this._series = this._options.series),
			(this._body = h('div', 'jvm-legend')),
			this._options.cssClass && this._body.setAttribute('class', this._options.cssClass),
			(l.vertical ? this._map.legendVertical : this._map.legendHorizontal).appendChild(this._body),
			this.render();
	}
	var l0,
		e0,
		...
		k = {
			mill: function (l, e, t) {
				return {
					...
					y: (-this.radius * Math.log(Math.tan((45 + 0.4 * l) * this.radDeg))) / 0.8
				};
			},
			merc: function (l, e, t) {
				return {
			...
			aea: function (l, e, t) {
				var t = t * this.radDeg,
					...
					l = l * this.radDeg,
					e = e * this.radDeg,
					n = (Math.sin(a) + Math.sin(n)) / 2,
					a = Math.cos(a) * Math.cos(a) + 2 * n * Math.sin(a),
					e = n * (e - t),
					t = Math.sqrt(a - 2 * n * Math.sin(l)) / n,
					l = Math.sqrt(a - 2 * n * Math.sin(0)) / n;
				return { x: t * Math.sin(e) * this.radius, y: -(l - t * Math.cos(e)) * this.radius };
			},
			lcc: function (l, e, t) {
				var t = t * this.radDeg,
					e = e * this.radDeg,
					...
					l = l * this.radDeg,
					n =
						Math.log(Math.cos(a) * (1 / Math.cos(n))) /
						Math.log(Math.tan(Math.PI / 4 + n / 2) * (1 / Math.tan(Math.PI / 4 + a / 2))),
					a = (Math.cos(a) * Math.pow(Math.tan(Math.PI / 4 + a / 2), n)) / n,
					l = a * Math.pow(1 / Math.tan(Math.PI / 4 + l / 2), n),
					a = a * Math.pow(1 / Math.tan(Math.PI / 4 + 0), n);
				return {
					x: l * Math.sin(n * (e - t)) * this.radius,
					y: -(a - l * Math.cos(n * (e - t))) * this.radius
				};
			}
		},
		C =
			((k.degRad = 180 / Math.PI),
			(k.radDeg = Math.PI / 180),
			(k.radius = 6381372),
			{
				_setupContainerEvents: function () {
					...
					this.params.draggable &&
						(d.on(this.container, 'mousemove', function (l) {
							if (!a) return !1;
							(i.transX -= (e - l.pageX) / i.scale),
								(i.transY -= (t - l.pageY) / i.scale),
								i._applyTransform(),
								(e = l.pageX),
								(t = l.pageY);
						}),
						d.on(this.container, 'mousedown', function (l) {
						...
						this.params.zoomOnScroll &&
							d.on(this.container, 'wheel', function (l) {
								var e = 75 * ((l.deltaY || -l.wheelDelta || l.detail) >> 10 || 1),
									t = n.container.getBoundingClientRect(),
									a = l.pageX - t.left - window.pageXOffset,
									t = l.pageY - t.top - window.pageYOffset,
									e = Math.pow(1 + i.params.zoomOnScrollSpeed / 1e3, -1.5 * e);
								i.tooltip && i._tooltip.hide(), i._setScale(i.scale * e, a, t), l.preventDefault();
							});
				},
				_setupElementEvents: function () {
					var e,
						...
						n = this,
						l = this.container;
					d.on(l, 'mousemove', function (l) {
						2 < Math.abs(e - l.pageX) + Math.abs(t - l.pageY) && (a = !0);
					}),
						d.delegate(l, 'mousedown', '.jvm-element', function (l) {
							(e = l.pageX), (t = l.pageY), (a = !1);
						}),
						d.delegate(l, 'mouseover mouseout', '.jvm-element', function (l) {
							var e = M(n, this, !0),
								t = n.params.showTooltip;
							'mouseover' === l.type
								? (e.element.hover(!0),
									t &&
										(n._tooltip.text(e.tooltipText),
										n._tooltip.show(),
										n._emit(e.event, [l, n._tooltip, e.code])))
								: (e.element.hover(!1), t && n._tooltip.hide());
						}),
						d.delegate(l, 'mouseup', '.jvm-element', function (l) {
							var e,
								t = M(n, this);
							!a &&
								(('region' === t.type && n.params.regionsSelectable) ||
									('marker' === t.type && n.params.markersSelectable)) &&
								((e = t.element),
								n.params[t.type + 'sSelectableOne'] && n._clearSelected(t.type + 's'),
								t.element.isSelected ? e.select(!1) : e.select(!0),
								n._emit(t.event, [t.code, e.isSelected, n._getSelected(t.type + 's')]));
						}),
						d.delegate(l, 'click', '.jvm-element', function (l) {
							var e = M(n, this),
								t = e.type,
								e = e.code;
							n._emit('region' === t ? f.onRegionClick : f.onMarkerClick, [l, e]);
						});
				},
				_setupZoomButtons: function () {
					function l(l) {
						return (
							...
							function () {
								return e._setScale(
									l ? e.scale * e.params.zoomStep : e.scale / e.params.zoomStep,
									e._width / 2,
									e._height / 2,
									!1,
					...
					var e = this,
						t = h('div', 'jvm-zoom-btn jvm-zoomin', '&#43;', !0),
						a = h('div', 'jvm-zoom-btn jvm-zoomout', '&#x2212', !0);
					this.container.appendChild(t), this.container.appendChild(a);
					d.on(t, 'click', l()), d.on(a, 'click', l(!1));
				},
						...
						'touchstart' == l.type && (p = 0),
							1 == a.length
								? (1 == p &&
										((t = m.transX),
										(e = m.transY),
										(m.transX -= (s - a[0].pageX) / m.scale),
										(m.transY -= (r - a[0].pageY) / m.scale),
										m._tooltip.hide(),
										m._applyTransform(),
										(t == m.transX && e == m.transY) || l.preventDefault()),
									(s = a[0].pageX),
									(r = a[0].pageY))
								: 2 == a.length &&
									(2 == p
										? ((t =
												Math.sqrt(
													Math.pow(a[0].pageX - a[1].pageX, 2) +
														Math.pow(a[0].pageY - a[1].pageY, 2)
												) / i),
											m._setScale(n * t, o, h),
											m._tooltip.hide(),
											l.preventDefault())
										: ((t = {
												top: (e = m.container.getBoundingClientRect()).top + window.scrollY,
												left: e.left + window.scrollX
											}),
											(o =
												a[0].pageX > a[1].pageX
													? a[1].pageX + (a[0].pageX - a[1].pageX) / 2
													: a[0].pageX + (a[1].pageX - a[0].pageX) / 2),
											(h =
												a[0].pageY > a[1].pageY
													? a[1].pageY + (a[0].pageY - a[1].pageY) / 2
													: a[0].pageY + (a[1].pageY - a[0].pageY) / 2),
											(o -= t.left),
											(h -= t.top),
											(n = m.scale),
											(i = Math.sqrt(
												Math.pow(a[0].pageX - a[1].pageX, 2) + Math.pow(a[0].pageY - a[1].pageY, 2)
											)))),
							(p = a.length);
					}
					var n,
						...
						p,
						m = this;
					d.on(m.container, 'touchstart', l), d.on(m.container, 'touchmove', l);
				},
				_createRegions: function () {
					...
					this._mapData.paths)) {
						var e = new N({
							...
							style: p({}, this.params.regionStyle),
				...
				_createLines: function (l, e, t) {
					...
					l)) {
						...
						for (s in e) {
							...
							o.name === r.from && (n = this.getMarkerPosition(o)),
								o.name === r.to && (i = this.getMarkerPosition(o));
						}
						!1 !== n &&
							!1 !== i &&
							(this._lines[m(r.from, r.to)] = new K({
								index: a,
								map: this,
								style: p({ initial: this.params.lineStyle }, { initial: r.style || {} }, !0),
								x1: n.x,
								y1: n.y,
								x2: i.x,
								y2: i.y,
				...
				_createMarkers: function (a, n) {
					...
					for (i in a)
						!(function () {
							var l = a[i],
								e = s.getMarkerPosition(l),
								t = l.coords.join(':');
							if (!e) return;
							if (n) {
								if (
									Object.keys(s._markers).filter(function (l) {
										return s._markers[l]._uid === t;
									}).length
								)
									return;
								i = Object.keys(s._markers).length;
							}
							e = new V({
								index: i,
								map: s,
								style: p(s.params.markerStyle, { initial: l.style || {} }, !0),
								label: s.params.labels && s.params.labels.markers,
								labelsGroup: s._markerLabelsGroup,
								cx: e.x,
								cy: e.y,
								group: s._markersGroup,
								marker: l,
								isRecentlyCreated: n
							});
							s._markers[i] && s.removeMarkers([i]),
								(s._markers[i] = { _uid: t, config: l, element: e });
						})();
				},
				_createSeries: function () {
					for (var l in ((this.series = { markers: [], regions: [] }), this.params.series))
						for (var e = 0; e < this.params.series[l].length; e++)
							this.series[l][e] = new J(
					...
					var l,
						...
						t =
							this._defaultWidth * this.scale <= this._width
								? ((l = (this._width - this._defaultWidth * this.scale) / (2 * this.scale)),
									(this._width - this._defaultWidth * this.scale) / (2 * this.scale))
								: ((l = 0), (this._width - this._defaultWidth * this.scale) / this.scale),
						a =
							this._defaultHeight * this.scale <= this._height
								...
								: ((e = 0), (this._height - this._defaultHeight * this.scale) / this.scale);
				...
				_setScale: function (l, e, t, a, n) {
					var i,
						...
						u = this,
						Z = 0,
						d = Math.abs(Math.round((60 * (l - this.scale)) / Math.max(l, this.scale)));
					l > this.params.zoomMax * this._baseScale
						...
						void 0 !== e &&
							...
							((M = l / this.scale),
							(M = a
								? ((c = e + (this._defaultWidth * (this._width / (this._defaultWidth * l))) / 2),
									t + (this._defaultHeight * (this._height / (this._defaultHeight * l))) / 2)
								: ((c = this.transX - ((M - 1) / l) * e), this.transY - ((M - 1) / l) * t))),
						n && 0 < d
							? ((s = this.scale),
								(r = (l - s) / d),
								...
								(i = setInterval(function () {
									(Z += 1),
										(u.scale = s + r * Z),
										(u.transX = (o + h * Z) / u.scale),
										(u.transY = (p + m * Z) / u.scale),
										u._applyTransform(),
										Z == d &&
											(clearInterval(i),
											u._emit(f.onViewportChange, [u.scale, u.transX, u.transY]));
								}, 10)))
							: ((this.transX = c),
								(this.transY = M),
								(this.scale = l),
								this._applyTransform(),
								this._emit(f.onViewportChange, [this.scale, this.transX, this.transY]));
				},
				setFocus: function (l) {
					var e,
						t,
						...
						n = [];
					return (
						(l = void 0 === l ? {} : l).region ? n.push(l.region) : l.regions && (n = l.regions),
						n.length
							? (n.forEach(function (l) {
									a.regions[l] &&
										(l = a.regions[l].element.shape.getBBox()) &&
										(e =
											void 0 === e
												? l
												: {
								...
								this._setScale(
									Math.min(this._width / e.width, this._height / e.height),
									-(e.x + e.width / 2),
									-(e.y + e.height / 2),
									!0,
									l.animate
							...
							: l.coords
								? ((n = this.coordsToPoint(l.coords[0], l.coords[1])),
									(t = this.transX - n.x / this.scale),
									(n = this.transY - n.y / this.scale),
									this._setScale(l.scale * this._baseScale, t, n, !0, l.animate))
								: void 0
					);
				},
				updateSize: function () {
				...
				coordsToPoint: function (l, e) {
					var t,
						a = L.maps[this.params.map].projection,
						l = k[a.type](l, e, a.centralMeridian),
						e = l.x,
						a = l.y,
						l = this.getInsetForPoint(e, a);
					return (
						!!l &&
						((e = ((e - (t = l.bbox)[0].x) / (t[1].x - t[0].x)) * l.width * this.scale),
						(a = ((a - t[0].y) / (t[1].y - t[0].y)) * l.height * this.scale),
						{
							x: e + this.transX * this.scale + l.left * this.scale,
							y: a + this.transY * this.scale + l.top * this.scale
						})
					);
				},
				getInsetForPoint: function (l, e) {
					for (var t = L.maps[this.params.map].insets, a = 0; a < t.length; a++) {
						var n = t[a].bbox,
							i = n[0],
							n = n[1];
						if (l > i.x && l < n.x && e > i.y && e < n.y) return t[a];
					}
				},
				getMarkerPosition: function (l) {
					l = l.coords;
					return L.maps[this.params.map].projection
						? this.coordsToPoint.apply(this, l)
						: {
								x: l[0] * this.scale + this.transX * this.scale,
								y: l[1] * this.scale + this.transY * this.scale
							};
				},
				_repositionLines: function () {
					var l,
						e = !1,
						t = !1;
					for (l in this._lines) {
						for (var a in this._markers) {
							a = this._markers[a];
							a.config.name === this._lines[l].config.from &&
								(e = this.getMarkerPosition(a.config)),
								a.config.name === this._lines[l].config.to &&
									(t = this.getMarkerPosition(a.config));
						}
						!1 !== e && !1 !== t && this._lines[l].setStyle({ x1: e.x, y1: e.y, x2: t.x, y2: t.y });
					}
				},
		...
		A =
			(((_ = h0.prototype)._createElement = function (l) {
				return document.createElementNS('http://www.w3.org/2000/svg', l);
			}),
			(_.addClass = function (l) {
		...
		x =
			(l(R, (t0 = A)),
			((_ = R.prototype).setStyle = function (l, e) {
				var t;
				p(this.style.current, 'object' == typeof l ? l : (((t = {})[l] = e), t)),
					this.updateStyle();
			}),
			(_.updateStyle = function () {
				var l = {};
				p(l, this.style.initial),
					p(l, this.style.current),
					this.isHovered && p(l, this.style.hover),
					this.isSelected &&
						(p(l, this.style.selected), this.isHovered) &&
						p(l, this.style.selectedHover),
					this.set(l);
			}),
			R),
		a0 =
			(l(P, (w = x)),
			(P.prototype.applyAttr = function (l, e) {
				'text' === l ? (this.node.textContent = e) : w.prototype.applyAttr.call(this, l, e);
			}),
			P),
		n0 =
			(l(G, (S = x)),
			(G.prototype.applyAttr = function (l, e) {
				var t;
				'image' === l
					? ('object' == typeof e
							? ((t = e.url), (this.offset = e.offset || [0, 0]))
							: ((t = e), (this.offset = [0, 0])),
						this.node.setAttributeNS('http://www.w3.org/1999/xlink', 'href', t),
						(this.width = 23),
						(this.height = 23),
					...
					: 'cx' == l
						? ((this.cx = e),
							this.width && this.applyAttr('x', e - this.width / 2 + this.offset[0]))
						: 'cy' == l
							? ((this.cy = e),
								this.height && this.applyAttr('y', e - this.height / 2 + this.offset[1]))
							: S.prototype.applyAttr.apply(this, arguments);
			}),
			G),
		i0 =
			(l(j, (e0 = A)),
			((_ = j.prototype).setSize = function (l, e) {
				this.node.setAttribute('width', l), this.node.setAttribute('height', e);
			}),
			(_.applyTransformParams = function (l, e, t) {
				this._rootElement.node.setAttribute(
					'transform',
					'scale(' + l + ') translate(' + e + ', ' + t + ')'
				);
			}),
			(_.createPath = function (l, e) {
				l = new x('path', l, e);
				return l.node.setAttribute('fill-rule', 'evenodd'), this._add(l);
			}),
			(_.createCircle = function (l, e, t) {
				l = new x('circle', l, e);
				return this._add(l, t);
			}),
			(_.createLine = function (l, e, t) {
				l = new x('line', l, e);
				return this._add(l, t);
			}),
			(_.createText = function (l, e, t) {
				l = new a0(l, e);
				return this._add(l, t);
			}),
			(_.createImage = function (l, e, t) {
				l = new n0(l, e);
				return this._add(l, t);
			}),
			(_.createGroup = function (l) {
				var e = new A('g');
		...
		s0 =
			(l(E, (l0 = g)),
			((_ = E.prototype)._bindEventListeners = function () {
				var r = this;
				d.on(this._map.container, 'mousemove', function (l) {
					var e, t, a, n, i, s;
					r._tooltip.classList.contains('active') &&
						((e = r._map.container),
						(e = Element.prototype.querySelector
							.call(e, '#jvm-regions-group')
							.getBoundingClientRect()),
						(t = (a = r._tooltip.getBoundingClientRect()).height),
						(a = a.width),
						(n = l.clientY <= e.top + t + 5),
						(i = l.pageY - t - 5),
						(s = l.pageX - a - 5),
						n && ((i += t + 5), (s -= 10)),
						l.clientX < e.left + a + 5 && ((s = l.pageX + 5 + 2), n) && (s += 10),
						r.css({ top: i + 'px', left: s + 'px' }));
				});
			}),
			...
			(_.text = function (l, e) {
				e = (e = void 0 === e ? !1 : e) ? 'innerHTML' : 'textContent';
				if (!l) return this._tooltip[e];
				this._tooltip[e] = l;
			}),
			(_.css = function (l) {
			...
			E),
		r0 =
			(((g = o0.prototype).setMinMaxValues = function (l) {
				for (var e in ((this.min = Number.MAX_VALUE), (this.max = 0), l))
					(e = parseFloat(l[e])) > this.max && (this.max = e), e < this.min && (this.min = e);
			}),
			(g.visualize = function () {
				...
				for (e in this._values)
					(l = parseFloat(this._values[e])), isNaN(l) || (t[e] = this.getValue(l));
				this.setAttributes(t);
			}),
			(g.setAttributes = function (l) {
				for (var e in l)
					this._map.regions[e] && this._map.regions[e].element.setStyle('fill', l[e]);
			}),
			(g.getValue = function (l) {
				for (var e, t = '#', a = 0; a < 3; a++)
					t +=
						(1 ===
						(e = Math.round(
							this._fromColor[a] +
								(this._toColor[a] - this._fromColor[a]) * ((l - this.min) / (this.max - this.min))
						).toString(16)).length
							? '0'
							: '') + e;
				return t;
			}),
			(g.hexToRgb = function (l) {
				var e = 0,
					t = 0,
					a = 0;
				return (
					4 == l.length
						? ((e = '0x' + l[1] + l[1]), (t = '0x' + l[2] + l[2]), (a = '0x' + l[3] + l[3]))
						: 7 == l.length &&
							((e = '0x' + l[1] + l[2]), (t = '0x' + l[3] + l[4]), (a = '0x' + l[5] + l[6])),
					[parseInt(e), parseInt(t), parseInt(a)]
				);
			}),
			o0),
		L =
			(((_ = T.prototype)._init = function () {
				var l = this.params;
				(this.container = i(l.selector)),
					this.container.classList.add('jvm-container'),
					(this.canvas = new i0(this.container)),
					...
					l.showTooltip && (this._tooltip = new s0(this)),
					...
					l.visualizeData && (this.dataVisualization = new r0(l.visualizeData, this)),
					l.bindTouchEvents &&
					...
					l.series &&
						(this.container.appendChild(
							(this.legendHorizontal = h('div', 'jvm-series-container jvm-series-h'))
						),
						this.container.appendChild(
							(this.legendVertical = h('div', 'jvm-series-container jvm-series-v'))
						),
						this._createSeries()),
					this._emit(f.onLoaded, [this]);
			}),
			(_.setBackgroundColor = function (l) {
				this.container.style.backgroundColor = l;
			}),
			(_.getSelectedRegions = function () {
				return this._getSelected('regions');
			}),
			(_.clearSelectedRegions = function () {
				this._clearSelected('regions');
			}),
			(_.getSelectedMarkers = function () {
				return this._getSelected('_markers');
			}),
			(_.clearSelectedMarkers = function () {
				this._clearSelected('_markers');
			}),
			(_.addMarkers = function (l) {
				if (Array.isArray(l)) return this._createMarkers(l, !0);
				this._createMarkers([l], !0);
			}),
			(_.removeMarkers = function (l) {
				var e = this;
				(l = l || Object.keys(this._markers)).forEach(function (l) {
					e._markers[l].element.remove(), delete e._markers[l];
				});
			}),
			(_.addLine = function (l, e, t) {
				void 0 === t && (t = {}),
					console.warn('`addLine` method is deprecated, please use `addLines` instead.'),
					this._createLines([{ from: l, to: e, style: t }], this._markers, !0);
			}),
			(_.addLines = function (l) {
				var e = this._getLinesAsUids();
				Array.isArray(l) || (l = [l]),
					this._createLines(
						l.filter(function (l) {
							return !(-1 < e.indexOf(m(l.from, l.to)));
						}),
						this._markers,
						!0
					);
			}),
			(_.removeLines = function (l) {
				var e = this;
				(l = Array.isArray(l)
					? l.map(function (l) {
			...
			(_.removeLine = function (l, e) {
				console.warn('`removeLine` method is deprecated, please use `removeLines` instead.');
				l = m(l, e);
				this._lines.hasOwnProperty(l) && (this._lines[l].element.remove(), delete this._lines[l]);
			}),
			(_.reset = function () {
				for (var l in this.series)
					for (var e = 0; e < this.series[l].length; e++) this.series[l][e].clear();
				this.legendHorizontal && (s(this.legendHorizontal), (this.legendHorizontal = null)),
					this.legendVertical && (s(this.legendVertical), (this.legendVertical = null)),
			...
			(_.destroy = function (l) {
				var e = this;
				void 0 === l && (l = !0),
					d.flush(),
					this._tooltip.dispose(),
					this._emit(f.onDestroyed),
					l &&
			...
			(_.extend = function (l, e) {
				if ('function' == typeof this[l])
					throw new Error('The method [' + l + '] does already exist, please use another name.');
				T.prototype[l] = e;
			}),
			(_._emit = function (l, e) {
				for (var t in f)
					f[t] === l && 'function' == typeof this.params[t] && this.params[t].apply(this, e);
			}),
			(_._getSelected = function (l) {
				var e,
					t = [];
				for (e in this[l]) this[l][e].element.isSelected && t.push(e);
				return t;
			}),
			(_._setSelected = function (e, l) {
				var t = this;
				l.forEach(function (l) {
					t[e][l] && t[e][l].element.select(!0);
				});
			}),
			(_._clearSelected = function (e) {
				var t = this;
				this._getSelected(e).forEach(function (l) {
					t[e][l].element.select(!1);
				});
			}),
			(_._getLinesAsUids = function () {
				return Object.keys(this._lines);
			}),
			T);
	function T(l) {
		var e = this;
		if (((this.params = p(T.defaults, (l = void 0 === l ? {} : l), !0)), !T.maps[this.params.map]))
			throw new Error('Attempt to use map which was not loaded: ' + l.map);
		(this.regions = {}),
			(this.scale = 1),
			(this.transX = 0),
			(this.transY = 0),
	...
	function o0(l, e) {
		...
		(this._scale = t),
			...
			(this._map = e),
			this.setMinMaxValues(l),
			this.visualize();
	}
	function E(l) {
		var e = l0.call(this) || this,
			t = h('div', 'jvm-tooltip');
		return (
			(e._map = l),
			(e._tooltip = document.body.appendChild(t)),
			e._bindEventListeners(),
			a(e) || a(e)
		);
	}
	function j(l) {
		var e;
		return (
			((e = e0.call(this, 'svg') || this)._container = l),
			(e._defsElement = new A('defs')),
			(e._rootElement = new A('g', { id: 'jvm-regions-group' })),
	...
	function G(l, e) {
		return S.call(this, 'image', l, e) || this;
	}
	function P(l, e) {
		return w.call(this, 'text', l, e) || this;
	}
	function R(l, e, t) {
		return (
			void 0 === t && (t = {}),
			((l = t0.call(this, l, e) || this).isHovered = !1),
			(l.isSelected = !1),
			(l.style = t),
			(l.style.current = {}),
			l.updateStyle(),
	...
	function p0(l) {
		if ((l = void 0 === l ? {} : l).selector) return new L(l);
	...
	return (
		...
		(p0.addMap = function (l, e) {
			L.maps[l] = e;
		}),
		(window.jsVectorMap = p0)
	);
}),
