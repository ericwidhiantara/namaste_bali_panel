!(function (e, t) {
	...
	return (
			...
			368: function (e) {
				e.exports = (function () {
					...
					function lt() {
						...
						var Ae = function e(t) {
							var n = l(t);
							if (!n || !n.tagName) n = { namespaceURI: M, tagName: 'template' };
							var r = Ue(t.tagName);
							var o = Ue(n.tagName);
							if (t.namespaceURI === ke) {
								if (n.namespaceURI === M) return r === 'svg';
								if (n.namespaceURI === we) return r === 'svg' && (o === 'annotation-xml' || Le[o]);
								return Boolean(D[r]);
							}
							if (t.namespaceURI === we) {
								if (n.namespaceURI === M) return r === 'math';
								if (n.namespaceURI === ke) return r === 'math' && Ne[o];
								return Boolean(Se[r]);
							}
							if (t.namespaceURI === M) {
								if (n.namespaceURI === ke && !Ne[o]) return false;
								if (n.namespaceURI === we && !Le[o]) return false;
						...
						var Oe = function e(t) {
							...
							if (!n || !n.documentElement) {
								n = h.createDocument(L, 'template', null);
								try {
							...
							if (L === M) return K.call(n, w ? 'html' : 'body')[0];
						...
						var Pe = function e(t) {
							...
							if (r === 'select' && $e(/<template/i, t.innerHTML)) {
								O(t);
								return true;
							}
							if (!v[r] || ie[r]) {
								if (he && !E[r]) {
									...
									var i = $(t) || t.childNodes;
									if (i && o) {
										var a = i.length;
										for (var s = a - 1; s >= 0; --s) o.insertBefore(V(i[s], true), W(t));
									}
								}
								O(t);
								return true;
							}
							if (t instanceof B && !Ae(t)) {
								O(t);
								return true;
							}
							if (
		...
		(sh.d = function (e, t) {
			for (var n in t)
				sh.o(t, n) && !sh.o(e, n) && Object.defineProperty(e, n, { enumerable: !0, get: t[n] });
		}),
		(sh.g = (function () {
		...
		(function () {
			...
			var X = sh(43),
				...
				e = sh(391),
				V = sh.n(e),
				W = (/Mac/.test(navigator.platform), /[\u0020]+/g),
				$ = /[>(){}[\]+-.!#|]/g,
				G =
				...
				if (((e = ze(e)), o && o.test(e))) {
					for (; -1 !== (s = e.search(o)); ) {
						var a = e.substring(0, s),
							a = (a && (r = We(r, a, t, i)), (e = e.substring(s)).match(o)[0]),
							s = 'widget' + n;
						r.push(t.nodes.widget.create({ info: s }, t.text(Ue(s, a)))),
							(e = e.substring(a.length));
					}
					e && (r = We(r, e, t, i));
				} else e && (r = n < qe.length - 1 ? We(r, e, t, i) : [t.text(e)]);
				return r;
			}
			function Ge(e) {
			...
			r(Lt, (Et = e)),
				...
				Object.defineProperty(Lt.prototype, 'schema', {
					get: function () {
						return {
			...
			(t.prototype.createState = function () {
					...
					var e = qe.map(function (e) {
						...
						return new Ce.InputRule(s, function (e, t, n, r) {
							...
							return (
								...
								t.length > a
									? ((n = $e((e = K(t)), o)), i.replaceWith(r - e.length + 1, r, n))
									: null
							);
						});
					});
				...
				(t.prototype.setHeight = function (e) {
					B()(this.el, { height: e + 'px' });
				}),
				(t.prototype.setMinHeight = function (e) {
					B()(this.el, { minHeight: e + 'px' });
				}),
			...
			function Bt(e, t, n) {
				var r = t === (n = void 0 === n ? t : n),
					...
					t = Math.max(n - s + 1, 1);
				return [
					[i, r + Ht(e.child(i - 1), r, -1)],
					[a, t + Ht(e.child(a - 1), t, -1)]
				];
			}
			function Ft(e, t) {
			...
			function Kt(e, t, n, r) {
				return [
					T(e, t, Ut),
					T(Be(e, n[1] + 1), Be(t, r), Ut, { desc: !0 }),
					T(Be(t, r + 2), u(t, -1), Ut, { url: !0 })
				];
			}
			function Qt(e, t, n, r) {
				var o = {
				...
				return 'item' !== e.type && 'blockQuote' !== e.type
					? [
							x(x({}, o), { end: t, spec: { attrs: { className: r + '-line-background start' } } }),
			...
			function Yt(e, t) {
				for (var n = []; e; ) {
					...
					('paragraph' !== r && 'codeBlock' !== r) ||
						n.push(T([Se(e), De(e) - 1], [Ae(e), Oe(e) + 1], t)),
						(e = e.next);
				}
				return n;
			}
			var Jt = {
					heading: function (e, t, n) {
						var r = e.level,
							e = e.headingType,
							o = [T(t, n, _t, { level: r })];
						return o.push('atx' === e ? T(t, u(t, r), $t) : T(Be(n, 0), n, _t, { seText: !0 })), o;
					},
					strong: Xt,
					emph: Xt,
					strike: Xt,
					link: function (e, t, n) {
						var r = e.lastChild,
							...
							r = r ? Oe(r) + 1 : 2;
						return e ? [T(t, n, Ut, { desc: !0 })] : Kt(t, n, t, r);
					},
					image: function (e, t, n) {
						var e = (e = e.lastChild) ? Oe(e) + 1 : 3,
							r = u(t, 1);
						return R([T(t, r, Wt)], Kt(t, n, r, e));
					},
					code: function (e, t, n) {
						var e = e.tickCount,
							r = u(t, e),
					...
					codeBlock: function (e, t, n, r) {
						var o = e.fenceOffset,
							...
							l = e.infoPadding,
							e = e.parent,
							c = [T(Be(t, 1), n, 'codeBlock')];
						return (
							a && c.push(T(t, u(t, o + i), $t)),
							s && c.push(T(u(t, i), u(t, i + l + s.length), Wt)),
							new RegExp('^(\\s{0,4})(' + a + '{' + i + ',})').test(r) &&
								c.push(T(Be(n, 1), n, $t)),
							(o = Qt(e, t, n, 'code-block')) ? c.concat(o) : c
						);
					},
						...
						return (
							...
							e.firstChild &&
								...
								'paragraph' === e.firstChild.type
									? (n = (function (e) {
											for (var t = []; e; )
												t.push(T([Se(e), De(e)], [Ae(e), Oe(e) + 1], Gt)), (e = e.next);
											return t;
										})(e.firstChild.firstChild))
									: 'list' === e.firstChild.type && (n = Yt(e.firstChild, Gt)),
								(t = R(R([], t), n))),
							t
						);
					},
					item: function (e, t) {
						var n = (r = e.listData).padding,
							...
							o = (function (e) {
								...
								return [zt, x(x({}, [{ odd: !0 }, { even: !0 }][t % 2]), { listStyle: !0 })];
							})(e),
							o = [T.apply(void 0, R([t, u(t, n)], o))];
						return (
							r &&
								(o.push(T(u(t, n), u(t, n + 3), 'taskDelimiter')),
								o.push(T(u(t, n + 1), u(t, n + 2), Wt))),
							o.concat(Yt(e.firstChild, Gt))
						);
					},
					customBlock: function (e, t, n) {
						var r = e.offset,
							...
							e = e.parent,
							r = r + o,
							a = [T(Be(t, 1), n, 'customBlock')];
						return (
							a.push(T(t, u(t, r), $t)),
							i && a.push(T(u(t, r), u(t, o + i.length), Wt)),
							a.push(T(Be(n, 1), n, $t)),
							(r = Qt(e, t, n, 'custom-block')) ? a.concat(r) : a
						);
					}
				},
				en = {
							...
							e.docChanged &&
											...
											(function (e, t, n) {
												...
												for (var o = t[0] - 1; o < n[0]; o += 1) {
													...
													if (i && a && !C(r, i)) {
														...
														for (var a = i - 1, s = n[0], l = a; l < s; l += 1) tn[l] = !0;
													}
												}
											})(p, d, f),
								...
								n.forEach(function (e) {
									var t = e.start,
										...
										l = w[o],
										c = w[i];
									if (((l += t[1] + Ht(a, t[1] - 1)), (c += n[1] + Ht(s, n[1] - 1)), r))
										if (e) {
											var a = m,
												u = v,
												t = b,
			...
			r(ln, (an = e)),
				...
				Object.defineProperty(ln.prototype, 'schema', {
					get: function () {
			...
			function cn() {}
			Object.defineProperty(cn.prototype, 'type', {
				get: function () {
					return 'mark';
				},
				enumerable: !1,
				...
				(cn.prototype.setContext = function (e) {
					this.context = e;
				});
			n = cn;
			function un(e, t) {
			...
			var dn,
				...
				hn =
					...
					Object.defineProperty(mn.prototype, 'schema', {
						get: function () {
							return {
								toDOM: function () {
					...
					(mn.prototype.createBlockQuoteText = function (e, t) {
						return t ? e.replace(fn, '').trim() : '> ' + e.trim();
					}),
					(mn.prototype.extendBlockQuote = function () {
						var c = this;
						return function (e, t) {
							var n = e.selection,
								r = e.doc,
					...
					(mn.prototype.commands = function () {
						var l = this;
						return function () {
							return function (e, t) {
								var n = e.selection,
			...
			var gn = /(^\s*)([-*+] |[\d]+\. )/,
				...
				xn = /(^\s*)([-*+])( \[[ xX]]) /;
			function Cn(e) {
				return vn.test(e) ? 'ordered' : 'bullet';
			}
			function Tn(e) {
				...
				return {
					changedResults: e.map(function (e, t) {
						var n,
							r,
							e = e.line,
							o = ((l = Math.min(e - 1, l)), (c = Math.max(e - 1, c)), un(i, e));
						return {
							text:
								'bullet' === a
									? ((n = o),
										gn.test(n)
											? ('bullet' === (r = Cn(n)) && bn.test(n)
													? (n = n.replace(xn, '$1$2 '))
													: 'ordered' === r && (n = n.replace(vn, '$1* ')),
												n)
											: '* ' + n)
									: ((r = o),
										(n = t + 1 + s),
										gn.test(r)
											? ('bullet' === (o = Cn(r)) || ('ordered' === o && bn.test(r))
													? (r = r.replace(bn, '$1' + n + '. '))
													: 'ordered' === o &&
														((o = yn.exec(r)[3]), Number(o) !== n) &&
														(r = r.replace(vn, '$1' + n + '. ')),
												r)
											: n + '. ' + r),
							line: e
			...
			var Nn = {
				...
				Sn = {
					bullet: function (e) {
						var t = e.doc,
							e = e.line;
						return { changedResults: [{ text: '* ' + un(t, e), line: e }] };
					},
					ordered: function (e) {
						for (
							var t = e.toastMark,
				...
				An = {
					...
					ordered: function (e) {
						var t = e.toastMark,
							...
							a = Number(a) + 1,
							r = '' + i + a + r,
							t = En(t, n, e, !0).filter(function (e) {
								var t = yn.exec(un(o, e.line));
								return t && t[1].length === i.length && !!He(e.mdNode, Re);
							});
						return x({ listSyntax: r }, Mn(o, t, 'ordered', a));
					}
				};
			var Dn = /(^\s{1,4})(.*)/;
			function On(e, t, n) {
				return e < t || gn.test(n) || fn.test(n);
			}
			function In(e, t, n) {
				var n = n.$from,
			...
			r(Bn, (Pn = e)),
				...
				(Bn.prototype.reorderList = function (e, t) {
					...
					p && (e = p.sourcepos[0][0]);
					for (
						var a = yn.exec(un(c, e)),
							i = a[1],
							a = a[3],
							i = i.length,
							r = (function e(t, n, r, o, i) {
								for (var a = [], s = un(t, r), l = yn.exec(s); l; ) {
									var c = l[1],
										u = l[4],
										p = l[5],
										d = c.length;
								...
								return !(
									...
									(u && On(a, s, r)) || (!u && gn.test(r))
										? (t(
												...
												})).setSelection(Rn(o, { type: 'indent', from: a, to: s, lineLen: i - c }))
											),
											yn.test(r) && p.reorderList(c + 1, i + 1))
										...
										? ((n = []),
											t(
												(r = Le({
													...
													Rn(r, { type: 'outdent', from: s, to: l, spaceLenList: n })
												)
											),
											yn.test(i) && d.reorderList(u + 1, a + 1))
										: p &&
			...
			r(jn, (Fn = e)),
				...
				Object.defineProperty(jn.prototype, 'schema', {
					get: function () {
						return { group: 'inline' };
					},
					enumerable: !1,
			...
			var _n,
				...
				Un =
					...
					Object.defineProperty(Vn.prototype, 'schema', {
						get: function () {
							return {
					...
					(Vn.prototype.createHeadingText = function (e, t, n) {
						for (var t = t.replace(n, '').trim(), r = ''; 0 < e; ) (r += '#'), --e;
						return r + ' ' + t;
					}),
					(Vn.prototype.commands = function () {
						var s = this;
						return function (a) {
							return function (e, t) {
								var n = a.level,
			...
			r(Gn, (Wn = n)),
				Object.defineProperty(Gn.prototype, 'name', {
					get: function () {
						return 'codeBlock';
					},
					enumerable: !1,
				...
				Object.defineProperty(Gn.prototype, 'schema', {
					get: function () {
						return {
							toDOM: function () {
				...
				(Gn.prototype.commands = function () {
					return function () {
						return function (e, t) {
							var n = e.selection,
								r = e.schema,
				...
				(Gn.prototype.keepIndentation = function () {
					var u = this;
					return function (e, t) {
						var n = e.selection,
							r = e.tr,
			...
			r(Yn, (Kn = n)),
				...
				Object.defineProperty(Yn.prototype, 'schema', {
					get: function () {
						return {
							toDOM: function () {
				...
				(Yn.prototype.extendTable = function () {
					var l = this;
					return function (e, t) {
						var n,
							r,
						...
						return (
							...
							(i = i.to),
							(a = pn(a, o)),
							!!(o = He(l.context.toastMark.findNodeAtPosition([o + 1, i - n + 1]), function (e) {
								return (
									Pe(e) &&
							...
							((i = !a.replace(Zn, '').trim()),
							(a = Xn(o.parent.parent.parent.columns.length)),
							i
				...
				(Yn.prototype.moveTableCell = function (c) {
					var u = this;
					return function (e, t) {
						var n,
							r,
							...
							l = a.endIndex,
							a = a.to,
							l = He(u.context.toastMark.findNodeAtPosition([l + 1, a - s]), Pe);
						return (
							!!l &&
							((a = l.parent),
							(o = (n = c
							...
							l[(r = n.type)]
								...
								: ((l = a[r] || a.parent.type !== n.parentType ? a[r] : a.parent[r][o]),
									'next' === r ? (i += (l ? Oe(l[o]) : 0) + 2) : 'prev' === r && (i = l ? -4 : 0)),
							t(e.setSelection(b(e, s + i))),
							!0)
						);
					};
				}),
				(Yn.prototype.addTable = function () {
					return function (s) {
						return function (e, t) {
							var n = e.selection,
								r = e.tr,
								...
								n = [Xn((n = e)), Xn(n, !0)],
								e = (function (e, t) {
									for (var n = [], r = 0; r < t; r += 1) n.push(Xn(e));
									return n;
								})(e, i - 1);
							return (
				...
				(Yn.prototype.commands = function () {
					return { addTable: this.addTable() };
				}),
				(Yn.prototype.keymaps = function () {
					return {
			...
			r(tr, (Jn = n)),
				...
				Object.defineProperty(tr.prototype, 'schema', {
					get: function () {
						return {
							toDOM: function () {
				...
				(tr.prototype.commands = function () {
					return { hr: this.hr() };
				}),
				(tr.prototype.keymaps = function () {
					var e = this.hr()();
			...
			r(or, (nr = n)),
				...
				(or.prototype.extendList = function () {
					var d = this;
					return function (e, t) {
						var n = e.selection,
							r = e.doc,
				...
				(or.prototype.toList = function (f) {
					var h = this;
					return function () {
						return function (e, t) {
							for (
				...
				(or.prototype.changeToListPerLine = function (a, s, e) {
					for (
						var l = e.from,
							t = e.startLine,
							n = e.endLine,
				...
				(or.prototype.toggleTask = function () {
					var h = this;
					return function (e, t) {
						for (
							var n = e.selection,
				...
				(or.prototype.commands = function () {
					return {
			...
			var ar,
				...
				lr =
					...
					(cr.prototype.bold = function () {
						return ir(sr, '**');
					}),
					(cr.prototype.commands = function () {
						return { bold: this.bold() };
					}),
					(cr.prototype.keymaps = function () {
						var e = this.bold()();
			...
			var ur,
				...
				dr =
					...
					(fr.prototype.commands = function () {
						return ir(pr, '~~');
					}),
					(fr.prototype.keymaps = function () {
						var e = this.commands()();
			...
			var hr,
				...
				gr =
					...
					(vr.prototype.italic = function () {
						return ir(mr, '*');
					}),
					(vr.prototype.commands = function () {
						return { italic: this.italic() };
					}),
					(vr.prototype.keymaps = function () {
						var e = this.italic()();
			...
			var yr,
				...
				wr =
					...
					Object.defineProperty(kr.prototype, 'schema', {
						get: function () {
							return {
					...
					(kr.prototype.commands = function () {
						return ir(br, '`');
					}),
					(kr.prototype.keymaps = function () {
						var e = this.commands()();
			...
			r(Tr, (xr = n)),
				...
				(Tr.prototype.addLinkOrImage = function (p) {
					return function (u) {
						return function (e, t) {
							var n = e.selection,
								r = e.tr,
			...
			r(Ir, (Dr = n)),
				...
				Object.defineProperty(Ir.prototype, 'schema', {
					get: function () {
						return {
							toDOM: function () {
			...
			r(Hr, (Rr = n)),
				...
				Object.defineProperty(Hr.prototype, 'schema', {
					get: function () {
						return {
							toDOM: function () {
			...
			r(qr, (Br = n)),
				Object.defineProperty(qr.prototype, 'name', {
					get: function () {
						return 'tableCell';
					},
					enumerable: !1,
				...
				Object.defineProperty(qr.prototype, 'schema', {
					get: function () {
						return {
							toDOM: function () {
			...
			r(zr, (jr = n)),
				...
				Object.defineProperty(zr.prototype, 'schema', {
					get: function () {
						return {
							toDOM: function () {
			...
			r(i, (Zr = Nt)),
									...
									return {
										update: function (e, t) {
											...
											(t && t.doc.eq(n) && t.selection.eq(r)) ||
												...
												(n = on((e = o.findNodeAtPosition(t)))),
												i.emit('changeToolbarState', { cursorPos: t, mdNode: e, toolbarState: n }),
											...
											return (
												o.empty &&
													...
													null !=
														(t =
															null ==
															(o = He(l.findNodeAtPosition([o + 1, t - r + 1]), function (e) {
																return (
																	'paragraph' === e.type &&
																...
																: o.firstChild)) &&
													t.literal &&
													(t = (r = o.firstChild).literal.match(Gr)) &&
													((o = r.sourcepos[0]),
													(r = t[1]),
													(n = t[2]),
													(t = t[3]),
				...
				(i.prototype.captureCopy = function (e, t) {
					...
					return (
						r.empty ||
							...
							'cut' === t &&
								this.view.dispatch(n.deleteSelection().scrollIntoView().setMeta('uiEvent', 'cut'))),
						!0
					);
				}),
					...
					r.docChanged &&
						r.steps.forEach(function (e, t) {
							...
							!e.slice ||
								...
								((n = (t = Bt(r.docs[t], (t = [e.from, e.to])[0], t[1]))[0]),
								(t = t[1]),
				...
				(i.prototype.getSelection = function () {
					var e = this.view.state.selection,
						t = e.from,
						e = e.to;
					return Bt(this.view.state.tr.doc, t, e);
				}),
				...
				(i.prototype.getRangeInfoOfNode = function (e) {
					...
					return (
						((n =
							'text' === n.type && 'paragraph' !== n.parent.type ? n.parent : n).sourcepos[1][1] +=
							1),
			...
			function io(e, t, n) {
				var r,
					...
					s = '';
				for (
					'string' != typeof t && ((n = t), (t = io.defaultChars)),
						void 0 === n && (n = !0),
						a = (function (e) {
							var t,
								n,
			...
			po.default = function (e) {
				return (55296 <= e && e <= 57343) || 1114111 < e
					? '�'
					: (e in fo.default && (e = fo.default[e]), ho(e));
			};
			var l =
					(Qr && Qr.__importDefault) ||
					function (e) {
				...
				mo =
					...
					(lo.decodeHTML = lo.decodeHTMLStrict = lo.decodeXML = void 0),
					l(co)),
				go = l(a),
				a = l(uo),
				vo = l(po),
				yo = /&(?:[a-zA-Z0-9]+|#[xX][\da-fA-F]+|#\d+);/g;
			function bo(e) {
				var t = ko(e);
				return function (e) {
					return String(e).replace(yo, t);
				};
			}
			(lo.decodeXML = bo(a.default)), (lo.decodeHTMLStrict = bo(mo.default));
			function wo(e, t) {
				return e < t ? 1 : -1;
			}
			function ko(n) {
				return function (e) {
					...
					return '#' === e.charAt(1)
						? 'X' === (t = e.charAt(2)) || 'x' === t
							? vo.default(parseInt(e.substr(3), 16))
							: vo.default(parseInt(e.substr(2), 10))
						: n[e.slice(1, -1)] || e;
				};
			}
			lo.decodeHTML = (function () {
				for (
					var e = Object.keys(go.default).sort(wo),
						t = Object.keys(mo.default).sort(wo),
						n = 0,
						r = 0;
					n < t.length;
					n++
			...
			(l.encodeHTML =
				...
				function (e) {
					return e
						.replace(To, function (e) {
							return Co[e];
						})
						.replace(Lo, So);
				})),
				(l.encodeNonAsciiHTML = Po(Qr));
			var Lo =
					/(?:[\x80-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])/g,
				No =
			...
			function So(e) {
				return '&#x' + (1 < e.length ? No(e) : e.charCodeAt(0)).toString(16).toUpperCase() + ';';
			}
			var Ao,
				Do,
				Oo,
				Io,
				Ro = new RegExp(xo.source + '|' + Lo.source, 'g');
			function Po(t) {
				return function (e) {
			...
			(l.escape = function (e) {
				return e.replace(Ro, So);
			}),
				(l.escapeUTF8 = function (e) {
					return e.replace(xo, So);
				}),
				(a = so),
				...
				Object.defineProperty(a, 'encodeHTML', {
					enumerable: !0,
					get: function () {
						return Oo.encodeHTML;
					}
				}),
				Object.defineProperty(a, 'encodeNonAsciiHTML', {
					enumerable: !0,
					get: function () {
						return Oo.encodeNonAsciiHTML;
					}
				}),
				...
				Object.defineProperty(a, 'decodeHTML', {
					enumerable: !0,
					get: function () {
						return Io.decodeHTML;
					}
				}),
				Object.defineProperty(a, 'decodeHTMLStrict', {
					enumerable: !0,
					get: function () {
						return Io.decodeHTMLStrict;
					}
				}),
			...
			function Ho(e) {
				return e.charCodeAt(0) === Bo ? e.charAt(1) : so.decodeHTML(e);
			}
			var po = '&(?:#x[a-f0-9]{1,6}|#[0-9]{1,7}|[a-z][a-z0-9]{1,31});',
				Bo = 92,
				Fo = /[\\&]/,
				co = '[!"#$%&\'()*+,./:;<=>?@[\\\\\\]^_`{|}~-]',
				qo = new RegExp('\\\\' + co + '|' + po, 'gi'),
				jo = new RegExp('[&<>"]', 'g');
			function _o(e) {
				return Fo.test(e) ? e.replace(qo, Ho) : e;
			}
			function zo(t) {
				try {
					return ao(t);
			...
			function Vo(e) {
				return jo.test(e) ? e.replace(jo, Uo) : e;
			}
			function Wo(e, t) {
			...
			(Zo.prototype.next = function () {
				...
				(Zo.prototype.resumeAt = function (e, t) {
			...
			(ei.prototype.isContainer = function () {
				return Xo(this);
			}),
				(ei.prototype.unlink = function () {
					this.prev
				...
				(ei.prototype.replaceWith = function (e) {
					this.insertBefore(e), this.unlink();
				}),
				(ei.prototype.insertAfter = function (e) {
					e.unlink(),
						(e.next = this.next),
				...
				(ei.prototype.insertBefore = function (e) {
					e.unlink(),
						(e.prev = this.prev),
				...
				(ei.prototype.appendChild = function (e) {
					e.unlink(),
			...
			var oi,
				ii = ai;
			function ai() {
				var e = (null !== oi && oi.apply(this, arguments)) || this;
			...
			var ui,
				pi = di;
			function di() {
				var e = (null !== ui && ui.apply(this, arguments)) || this;
				return (
					(e.isFenced = !1),
					(e.fenceChar = null),
					(e.fenceLength = 0),
			...
			var fi,
				hi = mi;
			function mi() {
				var e = (null !== fi && fi.apply(this, arguments)) || this;
				return (e.columns = []), e;
			}
			to(yi, (gi = ni));
			var gi,
			...
			var bi,
				wi = ki;
			function ki() {
				var e = (null !== bi && bi.apply(this, arguments)) || this;
			...
			var xi,
				Ci = Ti;
			function Ti() {
				var e = (null !== xi && xi.apply(this, arguments)) || this;
			...
			var Ei,
				Mi = Li;
			function Li() {
				var e = (null !== Ei && Ei.apply(this, arguments)) || this;
			...
			var Ni,
				Si = Ai;
			function Ai() {
				var e = (null !== Ni && Ni.apply(this, arguments)) || this;
				...
				Vi = String.fromCodePoint
					...
					: ((_i = String.fromCharCode),
						...
						function () {
							...
							for (var i = ''; ++r < o; ) {
								var a = Number(e[r]);
								if (!isFinite(a) || a < 0 || 1114111 < a || zi(a) !== a)
									return String.fromCharCode(65533);
								a <= 65535 ? n.push(a) : n.push(55296 + ((a -= 65536) >> 10), (a % 1024) + 56320),
									(r + 1 === o || 16384 < n.length) && ((i += _i.apply(void 0, n)), (n.length = 0));
							}
							return i;
						}),
				Wi = '(?:[w-]+.)*[A-Za-z0-9-]+.[A-Za-z0-9-]+',
				$i = '[^<\\s]*[^<?!.,:*_?~\\s]',
				Gi = '[\\w.+-]+@(?:[\\w-]+\\.)+[\\w-]+';
			function Zi(e) {
				for (var t, n = new RegExp('(www|https?://).' + Wi + $i, 'g'), r = []; (t = n.exec(e)); ) {
					var o = (function (e) {
							var t = /\)+$/.exec(e);
							if (t) {
			...
			function Xi(e) {
				return ro(
					ro([], Zi(e)),
					(function (e) {
						for (var t, n = new RegExp(Gi, 'g'), r = []; (t = n.exec(e)); ) {
							var o = t[0];
							/[_-]+$/.test(o) ||
			...
			function Ki(e, v) {
				var y;
				for ('boolean' == typeof v && (v = Xi); (y = e.next()); )
					!(function () {
						var e = y.entering,
							t = y.node;
			...
			var lo = '\\\\' + co,
				...
				pa = /^<[A-Za-z][A-Za-z0-9.+-]{1,31}:[^<>\x00-\x20]*>/i,
				da = /^ *(?:\n *)?/,
				fa = /^[ \t\n\x0b\x0c\x0d]/,
				ha = /^\s/,
				ma = / *$/,
				...
				wa =
					...
					(c.prototype.spnl = function () {
						return this.match(da), !0;
					}),
					(c.prototype.parseBackticks = function (e) {
						var t = this.pos + 1,
							n = this.match(sa);
						if (null === n) return !1;
						for (var r, o, i, a, s = this.pos; null !== (r = this.match(aa)); )
							if (r === n)
								return (
					...
					(c.prototype.parseAutolink = function (e) {
						var t,
							...
							r,
							o = this.pos + 1;
						return (t = this.match(ua))
							? ((n = t.slice(1, t.length - 1)),
								((r = w('link', this.sourcepos(o, this.pos))).destination = zo('mailto:' + n)),
								(r.title = ''),
							...
							: !!(t = this.match(pa)) &&
									((n = t.slice(1, t.length - 1)),
									((r = w('link', this.sourcepos(o, this.pos))).destination = zo(n)),
									(r.title = ''),
									r.appendChild(k(n, this.sourcepos(o + 1, this.pos - 1))),
									e.appendChild(r),
									!0);
					...
					(c.prototype.parseLinkTitle = function () {
						var e = this.match(na);
						return null === e ? null : _o(e.substr(1, e.length - 2));
					}),
					(c.prototype.parseLinkDestination = function () {
						var e = this.match(ra);
						if (null !== e) return zo(_o(e.substr(1, e.length - 2)));
						if (60 === this.peek()) return null;
						for (var t = this.pos, n = 0, r = void 0; -1 !== (r = this.peek()); )
							if (92 === r && oa.test(this.subject.charAt(this.pos + 1)))
								...
								if (null !== fa.exec(Vi(r))) break;
								this.pos += 1;
							}
						return (this.pos === t && 41 !== r) || 0 !== n
							? null
							: zo(_o((e = this.subject.substr(t, this.pos - t))));
					}),
							...
							var a,
								...
								u =
									(40 === this.peek() &&
										...
										this.spnl() &&
										(fa.test(this.subject.charAt(this.pos - 1)) && (n = this.parseLinkTitle()),
										1) &&
										this.spnl() &&
										41 === this.peek()
											? ((this.pos += 1), (r = !0))
					...
					(c.prototype.parseEntity = function (e) {
						...
						return (
							!!(t = this.match(ia)) &&
							(e.appendChild(k(so.decodeHTML(t), this.sourcepos(n, this.pos))), !0)
						);
					}),
					(c.prototype.parseString = function (e) {
						...
						return (
							!!(t = this.match(ba)) &&
							(this.options.smart
								? ((n = t.replace(la, '…').replace(ca, function (e) {
										var t = 0,
											n = 0;
										return (
											e.length % 3 == 0
						...
						return (
							r && 'text' === r.type && ' ' === r.literal[r.literal.length - 1]
								? ((t = ' ' === r.literal[r.literal.length - 2]),
									(n = r.literal.length),
									(r.literal = r.literal.replace(ma, '')),
					...
					(c.prototype.parseReference = function (e, t) {
						...
						return null === s ||
							...
							!(a =
								null === this.match(va)
									? '' !== n && ((n = ''), (this.pos = i), null !== this.match(va))
									: a)) ||
							'' === (i = Yi(o))
							? ((this.pos = r), 0)
							: ((a = this.getReferenceDefSourcepos(e)),
								...
								(o.label = i),
								e.insertBefore(o),
								t[i] ? (this.refDefCandidateMap[o.id] = o) : (t[i] = ps(o)),
								this.pos - r);
					}),
					...
					(c.prototype.parseInline = function (e) {
						...
						return (
							n ||
								((this.pos += 1), e.appendChild(k(Vi(r), this.sourcepos(this.pos, this.pos + 1)))),
							!0
						);
					}),
					(c.prototype.parse = function (e) {
						...
						var t = this.options,
							...
							r = t.customParser;
						if ((n && Ki(e.walker(), n), r && e.firstChild))
				...
				Da = {
						...
						continue: function (e) {
							...
							return e.indented || 62 !== La(t, e.nextNonspace)
								...
								: (e.advanceNextNonspace(),
									e.advanceOffset(1, !1),
									Sa(La(t, e.offset)) && e.advanceOffset(1, !0),
									0);
						},
						finalize: function () {},
						canContain: function (e) {
					...
					item: {
						...
						finalize: function (e, t) {
							...
							t.firstChild &&
								...
								(r = (n = t.firstChild).stringContent.match(ka)) &&
								((o = r[0].length),
					...
					paragraph: {
						...
						finalize: function (e, t) {
							if (null !== t.stringContent) {
								for (
									var n, r = !1;
									91 === La(t.stringContent, 0) && (n = e.inlineParser.parseReference(t, e.refMap));

								)
									(t.stringContent = t.stringContent.slice(n)), (r = !0);
								r && Na(t.stringContent) && t.unlink();
							}
						},
						canContain: function () {
							return !1;
					...
					customBlock: {
						continue: function (e, t) {
							...
							for (var o = t.offset; 0 < o && Sa(La(n, e.offset)); ) e.advanceOffset(1, !0), o--;
							return 0;
						},
						finalize: function (e, t) {
							var n, r, o;
			...
			function Wa(e, t) {
				var n = e.currentLine,
					r = e.lineNumber,
					o = e.indented;
				return 1 === r && !o && 'document' === t.type && Ga.test(n)
			...
			var $a = [
					function (e) {
						return e.indented || 62 !== La(e.currentLine, e.nextNonspace)
							...
							: (e.advanceNextNonspace(),
								e.advanceOffset(1, !1),
								Sa(La(e.currentLine, e.offset)) && e.advanceOffset(1, !0),
								e.closeUnmatchedBlocks(),
					...
					function (e, t) {
						var n;
						return e.indented || Va(e, t) || !(t = e.currentLine.slice(e.nextNonspace).match(ja))
							? 0
							: (e.advanceNextNonspace(),
					...
					function (e, t) {
						...
						if (
							...
							'paragraph' !== t.type ||
							Va(e, t.parent) ||
							!(n = e.currentLine.slice(e.nextNonspace).match(qa))
						)
							return 0;
						e.closeUnmatchedBlocks();
						for (
					...
					function (e) {
						return !e.indented && _a.test(e.currentLine.slice(e.nextNonspace))
							? (e.closeUnmatchedBlocks(),
					...
					function (e, t) {
						...
						return (e.indented && 'list' !== t.type) ||
							!(t = (function (e, t) {
								...
								if ((n = o.match(za))) (i.type = 'bullet'), (i.bulletChar = n[0][0]);
								else {
									if (!(n = o.match(Ua)) || ('paragraph' === t.type && '1' !== n[1])) return null;
								...
								if (
									'paragraph' === t.type &&
									!e.currentLine.slice(e.nextNonspace + n[0].length).match(Ta)
								)
									return null;
					...
					function (e, t) {
						...
						return 'paragraph' !== t.type ||
							...
							: ((p = t.lineOffsets),
								...
								p.appendChild(d),
								p.appendChild(f),
								Ia('tableCell', o, l, c + r).forEach(function (e) {
									d.appendChild(e);
								}),
								(h = Ia('tableDelimCell', a, e.lineNumber, e.nextNonspace + 1 + i)).forEach(
									function (e) {
										f.appendChild(e);
									}
								),
							...
							: (e.advanceOffset(e.currentLine.length - e.offset, !1),
								e.blank
									...
									: ('table' === (o = t).type &&
										...
										o.appendChild(n),
										(r = o.parent),
										(o = (t = Oa(e.currentLine.slice(e.nextNonspace)))[0]),
										Ia('tableCell', t[1], e.lineNumber, e.nextNonspace + 1 + o).forEach(
											function (e, t) {
					...
					function (e) {
						var t, n;
						return e.indented || Ha.test(e.currentLine) || !(t = e.currentLine.match(Pa))
							? 0
							: ((t = t[1].length),
								e.closeUnmatchedBlocks(),
			...
			var Ja = {
				...
				es =
					((ts.prototype.advanceOffset = function (e, t) {
						void 0 === t && (t = !1);
					...
					(ts.prototype.advanceNextNonspace = function () {
						(this.offset = this.nextNonspace),
							(this.column = this.nextNonspaceColumn),
							(this.partiallyConsumedTab = !1);
					}),
					(ts.prototype.findNextNonspace = function () {
						for (
					...
					(ts.prototype.addLine = function () {
						var e;
						this.partiallyConsumedTab &&
							((this.offset += 1),
							(e = 4 - (this.column % 4)),
							(this.tip.stringContent += Wo(' ', e))),
							this.tip.lineOffsets
								? this.tip.lineOffsets.push(this.offset)
								: (this.tip.lineOffsets = [this.offset]),
							(this.tip.stringContent += this.currentLine.slice(this.offset) + '\n');
					}),
					(ts.prototype.addChild = function (e, t) {
						for (; !Da[this.tip.type].canContain(e); ) this.finalize(this.tip, this.lineNumber - 1);
						t = w(e, [
							[this.lineNumber, t + 1],
							[0, 0]
						]);
					...
					(ts.prototype.closeUnmatchedBlocks = function () {
						if (!this.allClosed) {
					...
					(ts.prototype.finalize = function (e, t) {
						var n = e.parent;
						(e.open = !1),
					...
					(ts.prototype.processInlines = function (e) {
					...
					(ts.prototype.incorporateLine = function (e) {
						for (
							var t,
								n = this.doc,
								r =
						...
						for (
							...
							if (
								...
								'table' !== n.type &&
									...
									'paragraph' !== n.type &&
									!this.indented &&
									!Ka.test(e.slice(this.nextNonspace)))
							) {
							...
							Da[l].acceptsLines
								? (this.addLine(),
									'htmlBlock' === n.type &&
										1 <= n.htmlBlockType &&
										n.htmlBlockType <= 5 &&
										Xa[n.htmlBlockType].test(this.currentLine.slice(this.offset)) &&
					...
					(ts.prototype.parse = function (e, t) {
						(this.doc = Ya()),
							(this.tip = this.doc),
							(this.lineNumber = 0),
					...
					(ts.prototype.partialParseStart = function (e, t) {
						(this.doc = Ya()),
							(this.tip = this.doc),
							(this.lineNumber = e - 1),
							(this.lastLineLength = 0),
			...
			function ts(e) {
				(this.options = no(no({}, Ja), e)),
					...
					(this.lastLineLength = 0),
					(this.lines = []),
					this.options.frontMatter && ((Da.frontMatter = Za), $a.unshift(Wa)),
					(this.inlineParser = new wa(this.options));
			}
			function ns(e, t) {
			...
			function ss(e, t) {
				for (var n, r, o = e, i = null; o; ) {
					...
					var a = 1 === ns(a[1], n) ? 1 : -1 === ns(r, n) ? -1 : 0;
					if (0 == a) {
			...
			(f.prototype.updateLineTexts = function (e, t, n) {
				...
				return (e = this.lineTexts).splice.apply(e, ro([r - 1, a], n)), i - a;
			}),
					...
					e &&
						...
						((Fi(e.prev) &&
							...
							((i = o.match(/^[ \t]+/)) && (2 <= i[0].length || /\t/.test(i[0]))) ||
								((i = i ? o.slice(i.length) : o), za.test(i)) ||
								Ua.test(i))) ||
							('table' === e.prev.type &&
								!Na((o = this.lineTexts[n - 1])) &&
								-1 !== o.indexOf('|'))) &&
				...
				(f.prototype.markDeletedRefMap = function (e, t) {
					...
					ea(this.refMap) ||
						((n = function (e) {
							var t;
							qi(e) && (t = r.refMap[e.label]) && e.id === t.id && (t.unlinked = !0);
						}),
						e && cs(n, e.parent, t),
						t && cs(n, t));
				}),
				(f.prototype.replaceWithNewRefDefState = function (e) {
					...
					ea(this.refMap) ||
						((t = function (e) {
							var t, n;
							qi(e) && ((t = e.label), ((n = r.refMap[t]) && !n.unlinked) || (r.refMap[t] = ps(e)));
						}),
				...
				(f.prototype.replaceWithRefDefCandidate = function () {
					var i = this;
					ea(this.refDefCandidateMap) ||
						Ji(this.refDefCandidateMap, function (e, t) {
							var n = t.label,
								r = t.sourcepos,
								o = i.refMap[n];
							(!o || o.unlinked || o.sourcepos[0][0] > r[0][0]) && (i.refMap[n] = ps(t));
						});
				}),
				(f.prototype.getRangeWithRefDef = function (e, t, n, r, o) {
					...
					return (
						this.referenceDefinition &&
							...
							((i = is(this.root, e - 1)),
							(a = is(this.root, t + 1)),
							i && qi(i) && i !== n && i !== r && (e = (n = i).sourcepos[0][0]),
							a) &&
							qi(a) &&
							a !== n &&
							a !== r &&
				...
				(f.prototype.parseRefLink = function () {
					...
					return (
						ea(this.refMap) ||
							Ji(this.refMap, function (r, e) {
								e.unlinked && delete o.refMap[r],
									Ji(o.refLinkCandidateMap, function (e, t) {
										var n = t.node;
			...
			var ms = {
					...
					htmlInline: function (e, t) {
						return { type: 'html', content: t.options.tagFilter ? hs(e.literal) : e.literal };
					},
					htmlBlock: function (e, t) {
						(t = t.options), (e = t.tagFilter ? hs(e.literal) : e.literal);
						return t.nodeId
							? [
					...
					codeBlock: function (e) {
						var t = e.info,
							...
							n = [];
						return (
							0 < t.length && 0 < t[0].length && n.push('language-' + Vo(t[0])),
							[
						...
						return t.entering
							? ((t = e.title),
								(e = e.destination),
								{
									type: 'openTag',
									tagName: 'a',
									attributes: no({ href: Vo(e) }, t && { title: Vo(t) })
								})
					...
					image: function (e, t) {
						...
						return (
							t(),
							{
								...
								tagName: 'img',
								selfClose: !0,
								attributes: no({ src: Vo(o), alt: n(e) }, r && { title: Vo(r) })
							}
						);
					},
					customBlock: function (e, t, n) {
							...
							: ((n = 'tableHead' === (r = e.parent.parent).type ? 'th' : 'td'),
								(e =
									null != (r = r.parent.columns[e.startIdx]) && r.align
										...
										: null),
								t
									? no({ type: 'openTag', tagName: n, outerNewLine: !0 }, e && { attributes: e })
			...
			(ws.prototype.createConvertors = function () {
				var t,
					e,
					n,
					i = no({}, ms);
				return (
					this.options.gfm && (i = no(no({}, i), gs)),
				...
				(ws.prototype.getConvertors = function () {
					return this.convertors;
				}),
				(ws.prototype.getOptions = function () {
					return this.options;
				}),
					...
					for (
						...
						!(function () {
							...
							var r = !1,
								...
								t = ji(n) || 'customInline' === n.type ? t(n, e, s.convertors) : t(n, e);
							t &&
				...
				(ws.prototype.renderHTMLNode = function (e) {
					switch (e.type) {
						case 'openTag':
						case 'closeTag':
				...
				(ws.prototype.generateOpenTagString = function (e) {
					var n = this,
						t = e.tagName,
						r = e.classNames,
						o = e.attributes;
				...
				(ws.prototype.generateCloseTagString = function (e) {
					e = e.tagName;
					this.buffer.push('</' + e + '>');
				}),
				(ws.prototype.addNewLine = function () {
					this.buffer.length && '\n' !== Qi(Qi(this.buffer)) && this.buffer.push('\n');
				}),
				(ws.prototype.addOuterNewLine = function (e) {
					e.outerNewLine && this.addNewLine();
				}),
				(ws.prototype.addInnerNewLine = function (e) {
					e.innerNewLine && this.addNewLine();
				}),
				(ws.prototype.renderTextNode = function (e) {
					this.buffer.push(Vo(e.content));
				}),
				(ws.prototype.renderRawHtmlNode = function (e) {
					this.addOuterNewLine(e), this.buffer.push(e.content), this.addOuterNewLine(e);
				}),
				(ws.prototype.renderElementNode = function (e) {
					'openTag' === e.type
						...
						parseDOM: [
							{
								tag: n,
								getAttrs: function (e) {
									return { htmlAttrs: Ns(e), childrenHTML: e.innerHTML };
								}
							}
						],
						toDOM: function (e) {
						...
						parseDOM: [
							{
								tag: t,
								getAttrs: function (e) {
									return { htmlAttrs: Ns(e) };
								}
							}
						],
						toDOM: function (e) {
							e = Ss(e, t, n, r).htmlAttrs;
							return [t, e, 0];
						}
					};
				}
			...
			function Bs(e, t) {
				for (
					...
					e &&
					e !== t &&
					(C(Ps, e.tagName) || (n += e.offsetTop), e.offsetParent !== t.offsetParent);
			...
			function qs(e, t) {
				...
				for (
					...
					(C(Rs, i.type) || 'table' === i.type) && i.firstChild;
			...
			function _s(e) {
				e &&
					(delete js[Number(e.getAttribute('data-nodeid'))],
					ke()(e.children).forEach(function (e) {
						_s(e);
					}));
			}
			function zs(e, t, n) {
				var r = js[(r = n)] && js[r].height,
					o = js[(o = n)] && js[o].offsetTop,
					i = r || e.clientHeight,
					t = o || Bs(e, t) || e.offsetTop;
				return (
					r || ((e = i), (js[(r = n)] = js[r] || {}), (js[r].height = e)),
					o || ((r = t), (js[(e = n)] = js[e] || {}), (js[e].offsetTop = r)),
					{ nodeHeight: i, offsetTop: t }
				);
			}
			var Us = d('md-preview-highlight');
			function Vs(e, t) {
				var n = document.createElement('div'),
					n =
						((this.el = n),
					...
					t = t.highlight,
					t = void 0 !== t && t;
				(this.renderer = new bs({ gfm: !0, nodeId: !0, convertors: Is(n, e) })),
			...
			(Vs.prototype.initContentSection = function () {
				(this.previewContent = ut('<div class="' + d('contents') + '"></div>')),
					this.isViewer || this.el.appendChild(this.previewContent);
			}),
				(Vs.prototype.toggleActive = function (e) {
					ct(this.el, 'active', e);
				}),
				(Vs.prototype.initEvent = function (e) {
					var n = this;
					this.eventEmitter.listen('updatePreview', this.update.bind(this)),
						this.isViewer ||
							...
							Jr()(this.el, 'scroll', function (e) {
								n.eventEmitter.emit('scroll', 'preview', Fs(e.target.scrollTop, n.previewContent));
							}),
				...
				(Vs.prototype.removeHighlight = function () {
					var e;
					this.cursorNodeId && (e = this.getElementByNodeId(this.cursorNodeId)) && q()(e, Us);
				}),
				(Vs.prototype.updateCursorNode = function (e, t) {
					e &&
						('tableRow' ===
						(e = He(e, function (e) {
							switch (e.type) {
							...
							? (e = (function (e, t) {
									for (var n = e.firstChild; n && n.next && !(De(n.next) > t + 1); ) n = n.next;
									return n;
								})(e, t[1]))
				...
				(Vs.prototype.getElementByNodeId = function (e) {
				...
				(Vs.prototype.replaceRangeNodes = function (e) {
					var t = this,
						n = e.nodes,
						e = e.removedNodeRange,
					...
					if (e) {
						...
						if (o) {
							...
							null != a && a.parentNode && (lt(a), _s(a));
						}
					} else r.insertAdjacentHTML('afterbegin', n);
				}),
				(Vs.prototype.getRenderer = function () {
					return this.renderer;
				}),
				(Vs.prototype.destroy = function () {
					Yr()(this.el, 'scroll'), (this.el = null);
				}),
				(Vs.prototype.getElement = function () {
					return this.el;
				}),
				(Vs.prototype.getHTML = function () {
					return mt(this.previewContent.innerHTML);
				}),
				(Vs.prototype.setHTML = function (e) {
					this.previewContent.innerHTML = e;
				}),
				(Vs.prototype.setHeight = function (e) {
					B()(this.el, { height: e + 'px' });
				}),
				(Vs.prototype.setMinHeight = function (e) {
					B()(this.el, { minHeight: e + 'px' });
				});
			var Ws = Vs;
			function $s(e, t) {
				...
				var o,
					...
					s = (function (e, t) {
						...
						if ((e = t.contentMatch.findWrapping(e.type))) {
							for (var i = (e.length ? e[e.length - 1] : t).contentMatch, a = r; i && a < o; a += 1)
					...
					return (
						...
						(t(
							Gs(o)
								...
								: el(r, n, e.nodes.bulletList, { task: !0 })
						),
						!0)
					);
				};
					...
					outdent: function () {
						return function (e, t) {
							var n = e.selection,
								...
								o = n.$from,
								n = n.$to;
							return !(!o.blockRange(n) || !Gs(o)) && ol(r.nodes.listItem)(e, t);
						};
					}
				};
			}
					...
					((E.create = function (e) {
						...
						return a
							? ((t = a.node),
								(r = a.depth),
								(a = a.offset),
								(null == (i = sl.get(t)) ? void 0 : i.tableStartPos) === a + 1
									? i
									: ((n = []),
										(a = e.start(r)),
										(i = t.child(0)),
			...
			function ul(e, t) {
				return ve(Q.prototype, e), (cl = t), Q;
			}
			function pl(e, t) {
				void 0 === t && (t = e);
				var n = this,
				...
				return (
					((n = ll.call(this, r[0].$from, r[0].$to, r) || this).startCell = e),
					(n.endCell = t),
					(n.offsetMap = o),
					(n.isCellSelection = !0),
					(n.visible = !1),
			...
			r(pl, (ll = m.Selection)),
				(pl.prototype.map = function (e, t) {
					...
					return this.offsetMap.totalColumnCount > r.totalColumnCount ||
						...
						? ((r = { tableBody: 1, tableRow: 2, tableCell: 3, paragraph: 4 }[t.parent.type.name]),
							(r = t.end(t.depth - r)),
							(r = Math.min(r - 4, t.pos)),
							m.TextSelection.create(e, r))
						: new pl(n, t);
				}),
				(pl.prototype.eq = function (e) {
					return (
						e instanceof pl &&
			...
			var wl = new m.PluginKey('cellSelection');
			function kl(e) {
				(this.view = e),
					(this.handlers = {
			...
			(kl.prototype.init = function () {
				...
				(kl.prototype.setCellSelection = function (e, t) {
					var n = this.view.state,
						r = n.selection,
						n = n.tr,
						o = null === wl.getState(this.view.state),
						e = new dl(e, t);
					(!o && r.eq(e)) ||
						((r = n.setSelection(e)), o && r.setMeta(wl, t.pos), this.view.dispatch(r));
				}),
				...
				return t instanceof dl
					? ((n = []),
						t.ranges.forEach(function (e) {
							var t = e.$from,
								e = e.$to;
							n.push(be.Decoration.node(t.pos - 1, e.pos + 1, { class: Cl }));
						}),
			...
			(Ml.prototype.getKeyIndex = function (e) {
				return El()(e, this.keys);
			}),
				(Ml.prototype.get = function (e) {
					return this.values[this.getKeyIndex(e)];
				}),
				(Ml.prototype.set = function (e, t) {
			...
			(Nl.prototype.setCode = function (e) {
				this.code = e || 'en-US';
			}),
				(Nl.prototype.setLanguage = function (e, n) {
					var r = this;
					(e = [].concat(e)).forEach(function (e) {
						var t;
						r.langs.has(e) ? ((t = r.langs.get(e)), r.langs.set(e, H()(t, n))) : r.langs.set(e, n);
					});
				}),
				(Nl.prototype.get = function (e, t) {
					t = t || this.code;
			...
			var Dl = ['image', 'link', 'customBlock', 'frontMatter'],
				Ol = ['strong', 'strike', 'emph', 'code'],
				Il = ['bulletList', 'orderedList', 'taskList'];
			function Rl(e, t, u) {
				var p = e.$from,
					d = e.$to,
					n = e.from,
			...
			(Hl.prototype.renderToolArea = function () {
				var e = this,
				...
				(Hl.prototype.renderCustomBlock = function () {
				...
				(Hl.prototype.createInnerViewContainer = function () {
				...
				(Hl.prototype.closeEditor = function () {
				...
				(Hl.prototype.saveAndFinishEditing = function () {
				...
				(Hl.prototype.cancelEditing = function () {
				...
				(Hl.prototype.dispatchInner = function (e) {
					var e = this.innerEditorView.state.applyTransaction(e),
						t = e.state,
						n = e.transactions;
					if ((this.innerEditorView.updateState(t), !this.canceled && St()(this.getPos))) {
						for (
			...
			var Bl = 'image-link',
				Fl =
					((ql.prototype.createElement = function () {
						var e,
					...
					(ql.prototype.createImageElement = function (e) {
			...
			(_l.prototype.createElement = function () {
				...
				(_l.prototype.createCodeBlockElement = function () {
				...
				(_l.prototype.createLanguageEditor = function (e) {
					var t = this,
						n = e.top,
						e = e.right,
						...
						i =
							...
							r.clientWidth);
					B()(r, { top: n + 10 + 'px', left: e - i - 10 + 'px', width: i + 'px' }),
						(this.input = o),
				...
				(_l.prototype.bindDOMEvent = function () {
					this.dom && this.dom.addEventListener('click', this.handleMousedown);
				}),
				(_l.prototype.bindEvent = function () {
					var e = this;
					this.eventEmitter.listen('scroll', function () {
						e.input && e.reset();
					});
				}),
				(_l.prototype.changeLanguage = function () {
					var e, t, n;
					this.input &&
						St()(this.getPos) &&
						((e = this.input.value),
				...
				(_l.prototype.reset = function () {
					var e;
					null != (e = this.input) &&
						e.parentElement &&
						((e = this.input.parentElement), (this.input = null), lt(e));
				}),
				(_l.prototype.clearTimer = function () {
					this.timer && (clearTimeout(this.timer), (this.timer = null));
				}),
				(_l.prototype.stopEvent = function () {
					return !0;
				}),
				(_l.prototype.update = function (e) {
			...
			var zl = /MsoListParagraph/,
				Ul = /style=(.|\n)*mso-/,
				Vl = /mso-list:(.*)/,
				Wl = /O:P/,
				$l = /^(n|u|l)/,
				Gl = 'p.MsoListParagraph';
			function Zl(e) {
				for (var t = [], n = document.createTreeWalker(e, 1, null, !1); n.nextNode(); ) {
					...
					st(a) &&
						...
						o && !i && r
							? t.push([a, !0])
							: (Wl.test(a.nodeName) || (o && !r) || i) && t.push([a, !1]));
				}
				return (
					t.forEach(function (e) {
						var t = e[0];
						...
						if (t) {
							if (r) {
								...
								if (i.level < o.level) i.children.push(o), (o.parent = i);
									...
									i && ((o.prev = i), (o.parent = i.parent), o.parent) && o.parent.children.push(o);
								}
							}
							a.push(t);
						}
			...
			function Ql(e) {
				var i = document.createElement('div'),
					a = ((i.innerHTML = e), []),
					t = ((e = i), (t = Gl), (e = ke()(e.querySelectorAll(t))).length ? e : []);
				return (
					t.forEach(function (e) {
						var t,
							n,
			...
			var Yl = '\x3c!--StartFragment--\x3e',
				Jl = '\x3c!--EndFragment--\x3e';
			function ec(e) {
				var t, n, r;
				return (
					(n = (t = e).indexOf(Yl)),
					(r = t.lastIndexOf(Jl)),
					(e = (t = -1 < n && -1 < r ? t.slice(n + Yl.length, r) : t).replace(/<br[^>]*>/g, ot)),
					(n = e),
			...
			function nc(e, t, n) {
				var n = n.nodes,
					r = n.tableRow,
					e = tc(e, 0, n.tableHeadCell);
				return r.create(null, e);
			}
			function rc(e, t, n) {
				var n = n.nodes,
					r = n.tableRow,
					e = tc(e, 0, n.tableBodyCell);
				return r.create(null, e);
			}
			function oc(e) {
				var t = [],
			...
			function ac(e, t, n, r) {
				...
				return n && r
					? t.nodes.table.create(null, [ic(e, o, t)])
					: ((n = e[0]),
						(r = e.slice(1)),
						(n = [((e = nc((e = n), 0, (n = t))), n.nodes.tableHead.create(null, e))]),
						r.length && n.push(ic(r, o, t)),
				...
				if (p && i) {
					...
					var d = Q.create(p),
						...
						f =
							...
							(n = u),
							(r = []),
							(t = oc((t = t)))[0].childCount,
							(f = t.length),
							(i = 0 === i.startRowIdx),
							(t = t.slice(0, f)),
							i && (f = t.shift()) && ((i = nc(f, 0, n).content), r.push(i)),
							t.forEach(function (e) {
								e.attrs.dummyRowForPasting || ((e = rc(e, 0, n).content), r.push(e));
							}),
							r),
						i = uc(d, p, f),
						t = [];
					if (
						...
						for (
							...
							m.push({ rowIdx: b, startColIdx: v, endColIdx: H - F });
						if (i.addedColumnCount)
							for (
								...
								w.insert(N, L),
									_ <= M &&
										M <= U - V &&
										((L = k.getCellInfo(M, C - T)),
										(L = w.mapping.map(L.offset)),
										(j[E] = {
											rowIdx: M,
											startColIdx: z,
											endColIdx: C,
											dummyOffsets: [L, N + T * sc]
										}),
										(E += 1));
							}
						if (i.addedRowCount) {
							var p = o,
								...
								$ = t,
								A = (g = i).addedRowCount,
								D = g.addedColumnCount,
								O = g.startColIdx,
								I = g.endColIdx,
								g = p.mapping.maps.length,
								x = S.tableEndOffset - 2,
								h = fl(A, S.totalColumnCount + D, h),
								R = x;
							p.insert(p.mapping.slice(g).map(R), h);
							for (var P = 0; P < A; P += 1) {
								var G = R + cc(I + 1) + 1,
									Z = R + cc(S.totalColumnCount + D) + lc;
								$.push({
									rowIdx: P + S.totalRowCount,
									startColIdx: O,
									endColIdx: I,
									dummyOffsets: [R + O * sc + 1, G]
								}),
									(R = Z);
							}
						}
						(s = f),
							...
							u.dispatch(g.setSelection(new dl(p.resolve(f), p.resolve(h))));
					}
					return !0;
				}
				return !1;
			...
			r(hc, (dc = e)),
				Object.defineProperty(hc.prototype, 'name', {
					get: function () {
						return 'doc';
					},
					enumerable: !1,
				...
				Object.defineProperty(hc.prototype, 'schema', {
					get: function () {
						return { content: 'block+' };
					},
					enumerable: !1,
			...
			r(vc, (mc = e)),
				...
				Object.defineProperty(vc.prototype, 'schema', {
					get: function () {
						return {
							content: 'inline*',
							group: 'block',
			...
			var yc,
				...
				wc =
					...
					Object.defineProperty(kc.prototype, 'schema', {
						get: function () {
							return { group: 'inline' };
						},
						enumerable: !1,
					...
					(kc.prototype.addSpaces = function () {
						return function (e, t) {
							var n = e.selection,
								e = e.tr,
								r = n.$from,
					...
					(kc.prototype.removeSpaces = function () {
						return function (e, t) {
							var n = e.selection,
								e = e.tr,
								r = n.$from,
								o = n.$to,
								n = n.from;
							if (r.blockRange(o) && !Gs(r) && !Zs(r)) {
								var o = r.nodeBefore;
								if (o && o.isText)
									return (
										(o = (r = o.text).replace(bc, '')),
										(r = r.length - o.length),
										t(e.delete(n - r, n)),
										!0
									);
			...
			r(Tc, (xc = e)),
				Object.defineProperty(Tc.prototype, 'name', {
					get: function () {
						return 'heading';
					},
					enumerable: !1,
				...
				Object.defineProperty(Tc.prototype, 'levels', {
					get: function () {
						return [1, 2, 3, 4, 5, 6];
					},
					enumerable: !1,
				...
				Object.defineProperty(Tc.prototype, 'schema', {
					get: function () {
				...
				(Tc.prototype.commands = function () {
					return function (r) {
						return function (e, t) {
			...
			var xc,
				Cc = Tc;
			function Tc() {
				return (null !== xc && xc.apply(this, arguments)) || this;
			}
			r(Lc, (Ec = e)),
				...
				Object.defineProperty(Lc.prototype, 'schema', {
					get: function () {
						return {
							...
							toDOM: function (e) {
								e = e.attrs;
								return [e.rawHTML || 'pre', ['code', x({ 'data-language': e.language }, v(e)), 0]];
							}
						};
					},
					enumerable: !1,
			...
			r(Ac, (Nc = e)),
				...
				(Ac.prototype.changeList = function () {
					return function (e, t) {
						return nl(e.schema.nodes.bulletList)(e, t);
					};
				}),
				(Ac.prototype.commands = function () {
					return { bulletList: this.changeList, taskList: rl };
				}),
			...
			r(Ic, (Dc = e)),
				...
				Object.defineProperty(Ic.prototype, 'schema', {
					get: function () {
						return {
							content: 'listItem+',
							group: 'block',
				...
				(Ic.prototype.commands = function () {
					return function () {
						return function (e, t) {
							return nl(e.schema.nodes.orderedList)(e, t);
						};
					};
				}),
				(Ic.prototype.keymaps = function () {
					var e = this.commands()(),
						t = al(),
						n = t.indent,
						t = t.outdent;
			...
			r(Hc, (Rc = e)),
				...
				(Hc.prototype.liftToPrevListItem = function () {
					return function (e, t) {
						var n = e.selection,
							r = e.tr,
							e = e.schema,
					...
					return {
						...
						Enter: function (e, t) {
							...
							return (
								...
								n.replace(a ? r.before() : r.before(-1), r.after(-3), new X.Slice(s, a ? 3 : 2, 2)),
			...
			r(qc, (Bc = e)),
				Object.defineProperty(qc.prototype, 'name', {
					get: function () {
						return 'blockQuote';
					},
					enumerable: !1,
				...
				Object.defineProperty(qc.prototype, 'schema', {
					get: function () {
						return {
							attrs: x({ rawHTML: { default: null } }, h()),
							content: 'block+',
							group: 'block',
							parseDOM: [Ks('blockquote')],
							toDOM: function (e) {
				...
				(qc.prototype.commands = function () {
					return function () {
						return function (e, t) {
			...
			function _c(e, t, n, r, o) {
				if (e === L.RIGHT || e === L.DOWN) {
					if (
						o &&
						!(function (e) {
							for (var t, n, r, o = e.depth; o && 'tableBodyCell' !== (t = e.node(o)).type.name; ) {
			...
			function Vc(e, t, n, r) {
				...
				return r || !t.nodeAfter ? Me(e, t, n) : e.setSelection(m.Selection.near(t, 1));
			}
			function Wc(e, t, n, r) {
				n = (0, jc[e])(n, r);
				return n
					? ((r = e === L.RIGHT || e === L.DOWN ? 1 : -1),
						t.setSelection(m.Selection.near(t.doc.resolve(n), r)))
					: null;
			}
			((co = L = L || {}).LEFT = 'left'), (co.RIGHT = 'right'), (co.UP = 'up'), (co.DOWN = 'down');
			r(N, ($c = e)),
							...
							if (n && e) {
								for (
									var i = Q.create(n),
										...
										a = p === L.LEFT ? n.startColIdx : n.endColIdx + 1,
										s = bl(n).columnCount,
										l = i.totalRowCount,
										c = 0;
									c < l;
						...
						return function (e, t) {
							...
							if (n && e) {
								var o = Q.create(n),
									...
									i = o.totalRowCount;
								if (bl(n).columnCount === e) return !1;
								for (
					...
					return function (e, t) {
						...
						if (o && n) {
							var n = Q.create(o),
								o = n.getCellIndex(o),
								i = void 0;
							if ((i = Uc(a, n, o) ? Vc(r, n, e) : Wc(a, r, o, n))) return t(i), !0;
						}
						return !1;
					};
				}),
						...
						if (d.context.view.endOfTextblock(p)) {
							...
							if (c) {
								var u = $s(i, function (e) {
									...
									c = c.depth;
								if (u && zc(p, [c, u.depth], i, o)) {
									(u = vl(n).anchor), (o = Q.create(u)), (n = o.getCellIndex(u)), (u = void 0);
									if (
										(!(function (e, t, n) {
											var r,
												o,
											...
											if (e !== L.UP && e !== L.DOWN)
												return (
													...
													(n = t.nodeSize),
													(e === L.LEFT ? r : o) === (e === L.LEFT ? i - 2 : i + n + 3)
												);
										})(p, o, n)
											? Uc(p, o, n)
												? p === L.UP
				...
				(N.prototype.exitTable = function () {
					return function (e, t) {
						...
						if (
							...
							return (i = vl(n).anchor), t(Vc(r, Q.create(i), e, !0)), !0;
						return !1;
					};
				}),
				(N.prototype.commands = function () {
					return {
						...
						addColumnToLeft: this.addColumn(L.LEFT),
						addColumnToRight: this.addColumn(L.RIGHT),
						removeColumn: this.removeColumn(),
						addRowToUp: this.addRow(L.UP),
						addRowToDown: this.addRow(L.DOWN),
				...
				(N.prototype.keymaps = function () {
					...
					return {
						Tab: this.moveToCell(L.RIGHT),
						'Shift-Tab': this.moveToCell(L.LEFT),
						ArrowUp: this.moveInCell(L.UP),
						ArrowDown: this.moveInCell(L.DOWN),
						ArrowLeft: this.moveInCell(L.LEFT),
						ArrowRight: this.moveInCell(L.RIGHT),
						Backspace: e,
						'Mod-Backspace': e,
						Delete: e,
						'Mod-Delete': e,
			...
			r(Jc, (Qc = e)),
				Object.defineProperty(Jc.prototype, 'name', {
					get: function () {
						return 'tableBody';
					},
					enumerable: !1,
				...
				Object.defineProperty(Jc.prototype, 'schema', {
					get: function () {
						return {
							content: 'tableRow+',
							attrs: x({ rawHTML: { default: null } }, h()),
			...
			r(iu, (ru = e)),
				Object.defineProperty(iu.prototype, 'name', {
					get: function () {
				...
				Object.defineProperty(iu.prototype, 'schema', {
					get: function () {
						return {
							content: 'paragraph+',
							attrs: x(
			...
			r(lu, (au = e)),
				Object.defineProperty(lu.prototype, 'name', {
					get: function () {
				...
				Object.defineProperty(lu.prototype, 'schema', {
					get: function () {
						return {
			...
			r(pu, (cu = e)),
				Object.defineProperty(pu.prototype, 'name', {
					get: function () {
						return 'image';
					},
					enumerable: !1,
				...
				Object.defineProperty(pu.prototype, 'schema', {
					get: function () {
						return {
							inline: !0,
							attrs: x(
							...
							parseDOM: [
								{
									tag: 'img[src]',
									getAttrs: function (e) {
										var e = Es(e, { RETURN_DOM_FRAGMENT: !0 }).firstChild,
				...
				(pu.prototype.addImage = function () {
					return function (i) {
						return function (e, t) {
							var n = e.schema,
								e = e.tr,
				...
				(pu.prototype.commands = function () {
			...
			r(vu, (mu = n)),
				...
				Object.defineProperty(vu.prototype, 'schema', {
					get: function () {
				...
				(vu.prototype.commands = function () {
					return { bold: this.bold() };
				}),
				(vu.prototype.keymaps = function () {
					var e = this.bold()();
					return { 'Mod-b': e, 'Mod-B': e };
				});
			var mu,
				gu = vu;
			function vu() {
				return (null !== mu && mu.apply(this, arguments)) || this;
			}
			r(wu, (yu = n)),
				Object.defineProperty(wu.prototype, 'name', {
					get: function () {
						return 'emph';
					},
					enumerable: !1,
				...
				Object.defineProperty(wu.prototype, 'schema', {
					get: function () {
				...
				(wu.prototype.commands = function () {
					return { italic: this.italic() };
				}),
				(wu.prototype.keymaps = function () {
					var e = this.italic()();
					return { 'Mod-i': e, 'Mod-I': e };
				});
			var yu,
			...
			r(Cu, (ku = n)),
				Object.defineProperty(Cu.prototype, 'name', {
					get: function () {
						return 'strike';
					},
					enumerable: !1,
				...
				Object.defineProperty(Cu.prototype, 'schema', {
					get: function () {
				...
				(Cu.prototype.commands = function () {
					return function () {
						return function (e, t) {
			...
			var ku,
				xu = Cu;
			function Cu() {
				return (null !== ku && ku.apply(this, arguments)) || this;
			}
			r(Mu, (Tu = n)),
				Object.defineProperty(Mu.prototype, 'name', {
					get: function () {
						return 'link';
					},
					enumerable: !1,
				...
				Object.defineProperty(Mu.prototype, 'schema', {
					get: function () {
						var t = this;
						return {
							attrs: x(
				...
				(Mu.prototype.toggleLink = function () {
					return function (n) {
						return function (e, t) {
			...
			r(Ou, (Au = e)),
				...
				(Ou.prototype.commands = function () {
					return function (n) {
						return function (e, t) {
							return (
								!(null == n || !n.info) && (0, s.setBlockType)(e.schema.nodes.customBlock, n)(e, t)
							);
						};
					};
				});
			...
			r(S, (qu = Nt)),
				(S.prototype.createSpecs = function () {
					return (
				...
				(S.prototype.createSchema = function (e) {
					return new X.Schema({
						nodes: x(x({}, this.specs.nodes), e.nodes),
						marks: x(x({}, this.specs.marks), e.marks)
					});
				}),
				(S.prototype.createPlugins = function () {
					return R(
						[
							new m.Plugin({
								key: wl,
								...
								props: {
									...
									createSelectionBetween: function (e) {
										e = e.state;
										return U()(wl.getState(e)) ? null : e.selection;
									}
								},
								view: function (e) {
									return new xl(e);
									...
									return {
										update: function (e) {
											var e = e.state,
												...
												n = e.doc,
												e = e.schema;
											r.emit('changeToolbarState', { toolbarState: Rl(t, n, e) });
										}
									};
								}
							}))
				...
				(S.prototype.createPluginNodeViews = function () {
				...
				(S.prototype.createView = function () {
					...
					return new be.EditorView(this.el, {
						...
						transformPastedHTML: ec,
						transformPasted: function (e) {
							return (
								(e = e),
								(r = a.schema),
								(o = Zs(a.view.state.selection.$from)),
								(i = []),
								(t = e.content),
								(n = e.openStart),
								(e = e.openEnd),
								t.forEach(function (e) {
									var t, n;
									'table' === e.type.name
										? (t = yl(new X.Slice(X.Fragment.from(e), 0, 0))) &&
											((n = oc(t)),
				...
				(S.prototype.createCommands = function () {
					return this.specs.commands(this.view, al());
				}),
				...
				(S.prototype.getSchema = function () {
				...
				(S.prototype.setModel = function (e, t) {
					void 0 === t && (t = !1);
					var n = this.view.state,
						r = n.tr,
						n = n.doc;
			...
			function Vu() {
				var t = this;
				(this.events = new Ll()),
					(this.eventTypes = Uu.reduce(function (e, t) {
						return x(x({}, e), { type: t });
					}, {})),
					(this.hold = !1),
			...
			(Vu.prototype.listen = function (e, t) {
				...
				(Vu.prototype.emitReduce = function (e, t) {
				...
				(Vu.prototype.getTypeInfo = function (e) {
					e = e.split('.');
					return { type: e[0], namespace: e[1] };
				}),
				(Vu.prototype.hasEventType = function (e) {
					return !z()(this.eventTypes[this.getTypeInfo(e).type]);
				}),
				(Vu.prototype.addEventType = function (e) {
					if (this.hasEventType(e)) throw new Error('There is already have event type ' + e);
					this.eventTypes[e] = e;
				}),
				(Vu.prototype.removeEventHandler = function (e, t) {
					var n = this,
				...
				(Vu.prototype.removeEventHandlerWithHandler = function (e, t) {
					var n,
						e = this.events.get(e);
					e && ((n = e.indexOf(t)), 0 <= e.indexOf(t)) && e.splice(n, 1);
				}),
				(Vu.prototype.removeEventHandlerWithTypeInfo = function (e, t) {
					var n = [],
						r = this.events.get(e);
					r &&
						(r.map(function (e) {
				...
				(Vu.prototype.getEvents = function () {
					return this.events;
				}),
				(Vu.prototype.holdEventInvoke = function (e) {
			...
			function Ju(e) {
				...
				var r = document.createElement('div'),
					o = ((r.innerHTML = Es(e)), r.firstChild);
			...
			(ep = {
				...
				a: function (e, t, n) {
					...
					n
						? ((t = Ju(t, 'href')[0]), e.openMark(r.create({ linkUrl: t, rawHTML: n })))
						: e.closeMark(r);
				},
				img: function (e, t, n) {
					var r,
				...
				br: function (e, t) {
					...
					'paragraph' === (null == r ? void 0 : r.type)
						? (Qu(o) && e.openNode(n), Qu(t) ? e.closeNode() : t && (e.closeNode(), e.openNode(n)))
						: 'tableCell' === (null == r ? void 0 : r.type) &&
							(o && (Ku(o) || Xu(e, o)) && e.closeNode(), t) &&
							(Ku(t) || Xu(e, t)) &&
							e.openNode(n);
				},
				pre: function (e, t, n) {
					var r = document.createElement('div'),
						t =
							...
							null == (r = null == (t = r.firstChild) ? void 0 : t.firstChild)
								? void 0
								: r.textContent);
					e.openNode(e.schema.nodes.codeBlock, { rawHTML: n }), e.addText(Zu(t)), e.closeNode();
				},
				'ul, ol': function (e, t, n) {
					...
					'tableCell' === t.parent.type &&
						...
						(i = 'ul' === n ? i : r),
						n
							? (t.prev && !Yu(t.prev) && e.closeNode(), e.openNode(i, { rawHTML: n }))
							: (e.closeNode(), t.next && !Yu(t.next) && e.openNode(o)));
				},
				li: function (e, t, n) {
					var r, o, i;
					'tableCell' === (null == (o = t.parent) ? void 0 : o.type) &&
						...
						n
							? ((i = (i = t).literal),
								...
								t.prev && !Yu(t.prev) && e.closeNode(),
								e.openNode(r, x({ rawHTML: n }, i)),
								t.next && !Yu(t.next) && e.openNode(o))
							: (t.prev && !Yu(t.prev) && e.closeNode(), e.closeNode()));
				}
			}),
				(tp = {}),
			...
			var op = {
				...
				codeBlock: function (e, t, n) {
					var r = e.schema.nodes.codeBlock,
						o = t.info,
						t = t.literal;
					e.openNode(r, x({ language: o }, n)), e.addText(Zu(t || '')), e.closeNode();
				},
				...
				softbreak: function (e, t) {
					...
					'paragraph' === t.parent.type &&
						((n = t.prev), (t = t.next), n && !rp(n) && e.closeNode(), t) &&
						!rp(t) &&
				...
				code: function (e, t, n, r) {
					...
					e.openMark(o.create(r)), e.addText(Zu(t.literal || '')), e.closeMark(o);
				},
					...
					rt.test(i)
						...
						: ((n = (r = i.match(tt))[1]),
							...
							null != r && r.spec.attrs.htmlBlock
								? ((o = Ls(i)), (t = Ms(t, n)), e.addNode(r, { htmlAttrs: o, childrenHTML: t }))
								: ((a.innerHTML = i),
									(function n(e) {
			...
			(ip.prototype.top = function () {
				...
				(ip.prototype.convertByDOMParser = function (e) {
					var t = this;
				...
				(ip.prototype.closeUnmatchedHTMLInline = function (e, t) {
					var n;
				...
				(ip.prototype.convert = function (e, i) {
					for (
						var a = e.walker(),
							s = a.next(),
							t = function () {
				...
				(ip.prototype.convertNode = function (e, t) {
			...
			var sp = {
				...
				image: function (e, t, n) {
					n = n.attrs;
					e.write(
						'![' + (null == n ? void 0 : n.altText) + '](' + (null == n ? void 0 : n.imageUrl) + ')'
					);
				},
			...
			var dp = {
					...
					codeBlock: function (e) {
						var e = e.node,
							t = e.attrs,
							e = e.textContent;
						return { delim: ['```' + (t.language || ''), '```'], rawHTML: cp(t.rawHTML), text: e };
					},
					...
					bulletList: function (e, t) {
						...
						return { delim: '*', rawHTML: cp((e = t ? e || 'ul' : e)) };
					},
					orderedList: function (e, t) {
						(e = e.node), (t = t.inTable), (e = e.attrs.rawHTML);
						return { rawHTML: cp((e = t ? e || 'ol' : e)) };
					},
					listItem: function (e, t) {
						var e = e.node,
							t = t.inTable,
					...
					table: function (e) {
						return { rawHTML: cp(e.node.attrs.rawHTML) };
					},
					...
					thematicBreak: function (e) {
						return { delim: '***', rawHTML: up(e.node.attrs.rawHTML) };
					},
					...
					strong: function (e, t) {
						...
						return { delim: '**', rawHTML: (t ? up : pp)(e) };
					},
					emph: function (e, t) {
						(e = e.node), (t = t.entering), (e = e.attrs.rawHTML);
						return { delim: '*', rawHTML: (t ? up : pp)(e) };
					...
					code: function (e, t) {
						var n = e.node,
							...
							t = t.entering;
						return {
							delim: t ? lp(r.child(e), -1) : lp(r.child(e - 1), 1),
							rawHTML: (t ? up : pp)(n.attrs.rawHTML)
						};
					},
			...
			function hp(p) {
				var e = {};
				return (
					Object.keys(sp).forEach(function (u) {
						e[u] = function (e, t) {
							var n, r, o, i, a, s, l, c;
							sp[u] &&
								((l = p[u]),
			...
			function mp(t) {
				...
				return (
					(i = dp),
					(e = {}),
					Object.keys(fp).forEach(function (o) {
						e[o] = function (e, t) {
							var n = fp[o],
								r = i[o],
			...
			(A.prototype.getMarkConvertor = function (e) {
				e = e.attrs.htmlInline ? 'html' : e.type.name;
				return this.markTypeConvertors[e];
			}),
				(A.prototype.isInBlank = function () {
					return /(^|\n)$/.test(this.result);
				}),
				(A.prototype.markText = function (e, t, n, r) {
					var o = this.getMarkConvertor(e);
					return o
						? ((e = (o = o({ node: e, parent: n, index: r }, t)).delim), o.rawHTML || e)
						: '';
				}),
				(A.prototype.setDelim = function (e) {
					this.delim = e;
				}),
				(A.prototype.getDelim = function () {
					return this.delim;
				}),
				(A.prototype.flushClose = function (e) {
				...
				(A.prototype.wrapBlock = function (e, t, n, r) {
					var o = this.getDelim();
					this.write(t || e),
				...
				(A.prototype.ensureNewLine = function () {
				...
				(A.prototype.closeBlock = function (e) {
					this.closed = e;
				}),
				...
				(A.prototype.convertList = function (r, o, i) {
					var a = this,
						s =
				...
				(A.prototype.convertTableCell = function (r) {
					var o = this;
					(this.stopNewline = !0),
						(this.inTable = !0),
						r.forEach(function (e, t, n) {
				...
				(A.prototype.convertNode = function (r, o) {
					var i = this;
					return (
						r.forEach(function (e, t, n) {
			...
			function vp(e, t, n, r) {
				...
				(this.setMappedPos = function (e) {
					...
					(this.toWwConvertors =
						...
						(e = Object.keys(s)),
						(o = x({}, op)),
						(l = new bs({ gfm: !0, nodeId: !0, convertors: s }).getConvertors()),
						...
						o)),
					(this.toMdConvertors = mp(t || {})),
					this.eventEmitter.listen('setFocusedNode', function (e) {
						return (i.focusedNode = e);
					});
			}
			(vp.prototype.getMappedPos = function () {
				return this.mappedPosWhenConverting;
			}),
				(vp.prototype.getInfoForPosSync = function () {
					return { node: this.focusedNode, setMappedPos: this.setMappedPos };
				}),
				(vp.prototype.toWysiwygModel = function (e) {
					return new ap(this.schema, this.toWwConvertors).convertNode(e, this.getInfoForPosSync());
				}),
				(vp.prototype.toMarkdownText = function (e) {
					e = new gp(this.toMdConvertors).convertNode(e, this.getInfoForPosSync());
			...
			function bp(e) {
				var t = e.plugins,
					...
					f = e.instance;
				return (
					p.listen('mixinTableOffsetMapPrototype', ul),
					(null != t ? t : []).reduce(
						function (e, t) {
			...
			function wp(e) {
				var t,
					...
					o =
						...
						['htmlBlock', 'htmlInline'].forEach(function (e) {
							t[e] && Object.keys(t[e]).forEach(Ts);
						}),
						this.options.events &&
				...
				'light' !== o && a.classList.add(d(o)),
					...
					(this.preview = new Ws(this.eventEmitter, x(x({}, e), { isViewer: !0 }))),
					Jr()(this.preview.previewContent, 'mousedown', this.toggleTask.bind(this)),
					i ? this.setMarkdown(i) : u && this.preview.setHTML(u),
					a.appendChild(this.preview.previewContent),
					this.eventEmitter.emit('load', this);
			}
			(wp.prototype.toggleTask = function (e) {
				var t = e.target,
				...
				(wp.prototype.setMarkdown = function (e) {
				...
				(wp.prototype.on = function (e, t) {
					this.eventEmitter.listen(e, t);
				}),
				(wp.prototype.off = function (e) {
					this.eventEmitter.removeEventHandler(e);
				}),
				(wp.prototype.addHook = function (e, t) {
					this.eventEmitter.removeEventHandler(e), this.eventEmitter.listen(e, t);
				}),
				(wp.prototype.destroy = function () {
					Yr()(this.preview.el, 'mousedown', this.toggleTask.bind(this)),
						this.preview.destroy(),
						this.eventEmitter.emit('destroy');
				}),
				(wp.prototype.isViewer = function () {
					return !0;
				}),
				(wp.prototype.isMarkdownMode = function () {
					return !1;
				}),
				(wp.prototype.isWysiwygMode = function () {
					return !1;
				});
			var kp = wp;
			function xp(e) {
			...
			var Tp = {
				...
				Ep =
					((Mp.prototype.generateTokens = function (e) {
						(n = (r = e).attrs),
							(t = {
								type: (o = r.type.name),
								wysiwygNode: !0,
								literal: !Cp(o) && xp(r) ? r.textContent : null
							}),
							(n = {
						...
						var t = n ? x(x({}, o), { attrs: n, childrenHTML: r }) : o,
							...
							o = Xe()(o) ? o : [o];
						return (
							(Cp(e.type.name) || e.attrs.htmlInline) &&
								((n.entering = !1),
								o.push({ type: 'text', content: xp(e) ? e.textContent : '' }),
								(o = o.concat(r(t, n, this.convertors)))),
							o
						);
					}),
					(Mp.prototype.toDOMNode = function (e) {
						var e = this.generateTokens(e),
							t = [];
						return (
							e.forEach(function (e) {
								return Tp[e.type](e, t);
							}),
							t[0]
						);
					}),
					(Mp.prototype.getToDOMNode = function (e) {
			...
			function Mp(e, t) {
				...
				(this.customConvertorKeys = Object.keys(t).concat(Object.keys(n))),
					(this.renderer = new bs({ gfm: !0, convertors: x(x({}, e), n) })),
			...
			(Ip.prototype.addScrollSyncEvent = function () {
				var n = this;
				...
				(Ip.prototype.syncPreviewScrollTop = function (e) {
					void 0 === e && (e = !1);
					...
					if (i && 'htmlBlock' !== (s = (s = i).type) && 'htmlInline' !== s) {
						...
						if (l && !c) {
							...
							(u = this.getResolvedScrollTop('editor', l, u, s)), (this.latestEditorScrollTop = l);
						}
						u !== s && this.run('editor', u, s);
					}
				}),
				(Ip.prototype.syncEditorScrollTop = function (e) {
					...
					if (a && e && !o) {
						...
						(o = i.children),
							...
							(e = qs(this.previewRoot, t.findNodeById(i))),
							(t = e.mdNode),
							(e = e.el),
							(l = o[Se(t) - 1].offsetTop),
							(n = Hs(n.doc, t, o).height),
							(t = zs(e, r, i)),
							(o = t.nodeHeight),
							(e = t.offsetTop);
				...
				(Ip.prototype.clearTimer = function () {
					this.timer && (clearTimeout(this.timer), (this.timer = null));
				}),
			...
			function D(e) {
				var t,
					...
					s = new Ep(f, m.customHTMLRenderer),
					e =
				...
				(this.toastMark = new ds('', {
					...
					(this.mdEditor = new Kr(this.eventEmitter, {
						toastMark: this.toastMark,
					...
					(this.wwEditor = new _u(this.eventEmitter, {
						toDOMAdaptor: s,
						useCommandShortcut: d,
						htmlSchemaMap: e,
						linkAttributes: f,
					...
					(this.convertor = new yp(
						this.wwEditor.getSchema(),
						x(x({}, g), p),
						Is(f, m.customHTMLRenderer),
						this.eventEmitter
					)),
					...
					(this.scrollSync = new Op(this.mdEditor, this.preview, this.eventEmitter)),
					this.addInitEvent(),
			...
			(D.prototype.addInitEvent = function () {
				var t = this;
				...
				(D.prototype.addInitCommand = function (e, t) {
					function n(t, n) {
						Object.keys(n).forEach(function (e) {
				...
				(D.prototype.getCurrentModeEditor = function () {
					return this.isMarkdownMode() ? this.mdEditor : this.wwEditor;
				}),
				(D.factory = function (e) {
					return new (e.viewer ? kp : D)(e);
				}),
				(D.setLanguage = function (e, t) {
					M.setLanguage(e, t);
				}),
				(D.prototype.changePreviewStyle = function (e) {
				...
				(D.prototype.addCommand = function (n, e, r) {
					var o = this;
				...
				(D.prototype.addHook = function (e, t) {
					this.eventEmitter.removeEventHandler(e), this.eventEmitter.listen(e, t);
				}),
				(D.prototype.removeHook = function (e) {
					this.eventEmitter.removeEventHandler(e);
				}),
				...
				(D.prototype.moveCursorToEnd = function (e) {
					void 0 === e && (e = !0), this.getCurrentModeEditor().moveCursorToEnd(e);
				}),
				(D.prototype.moveCursorToStart = function (e) {
					void 0 === e && (e = !0), this.getCurrentModeEditor().moveCursorToStart(e);
				}),
				(D.prototype.setMarkdown = function (e, t) {
				...
				(D.prototype.setHTML = function (e, t) {
				...
				(D.prototype.getMarkdown = function () {
				...
				(D.prototype.setMinHeight = function (e) {
					var t;
					e !== this.minHeight &&
				...
				(D.prototype.getMinHeight = function () {
					return this.minHeight;
				}),
				(D.prototype.isMarkdownMode = function () {
					return 'markdown' === this.mode;
				}),
				(D.prototype.isWysiwygMode = function () {
					return 'wysiwyg' === this.mode;
				}),
				(D.prototype.isViewer = function () {
					return !1;
				}),
				(D.prototype.getCurrentPreviewStyle = function () {
					return this.mdPreviewStyle;
				}),
				(D.prototype.changeMode = function (e, t) {
					var n;
					this.mode === e ||
						((this.mode = e),
						this.isWysiwygMode()
				...
				(D.prototype.convertPosToMatchEditorMode = function (e, t, n) {
			...
			function jp(e, t) {
				...
				Pp()(e) || null == e
					? (n = null)
					: (j()(e) || _()(e)) &&
						((e = String(e)), (n = new Fp('TEXT_NODE', { nodeValue: e }, []))),
					n && t.push(n);
			}
			var O = function (e) {
					for (
			...
			var Up = /acit|ex(?:s|g|n|p|$)|rph|ows|mnc|ntw|ine[ch]|zoo|^ord/i;
			function Vp(o, i, a, s) {
							...
							: 'nodeValue' === e
								...
								: 'style' === e && _p()(a[e])
									? ((n = o),
										...
										Object.keys(r).forEach(function (e) {
											var t = r[e];
											n.style[e] = _()(t) && !Up.test(e) ? t + 'px' : t;
										}))
									: 'children' !== e &&
			...
			function Wp(e) {
				if ((Fp.removalNodes.forEach(Gp), e))
					...
					if (
						(e.node &&
							...
							'A' === e.effect
								...
								: 'U' === e.effect && zp(e.node, e.old.props, e.props)),
						'D' === e.effect)
					)
						for (var t, n, r = e.walker(); (t = r.walk()); )
							(e = t.vnode),
							...
							: e.node ||
								(e.node =
									...
									'TEXT_NODE' === (t = e).type
										...
										: Vp((o = document.createElement(t.type)), {}, t.props),
									o)),
						Xp(e),
						e.firstChild)
					)
					...
					t =
						(e.forEach(function (e, t) {
							...
							r &&
								...
								i && !r && (Fp.removalNodes.push(i), (i.effect = 'D')),
								(i = i && i.next),
								0 === t ? (o.firstChild = e) : e && (a.next = e),
								(a = e);
						}),
						K(e));
				if (!e.length) for (; i; ) Fp.removalNodes.push(i), (i.effect = 'D'), (i = i.next);
				for (; i && t; )
					i && t.old !== i && (Fp.removalNodes.push(i), (i.effect = 'D'), (i = i.next));
			}
			function Kp(e, t) {
				var n = new Fp(e.tagName.toLowerCase(), {}, [t]);
				return (
					(n.node = e),
					(Fp.removalNodes = []),
					Zp(n),
			...
			Yp.prototype.setState = function (e) {
			...
			r(nd, (Jp = Qp)),
				(nd.prototype.show = function () {
					this.setState({ hide: !1 });
				}),
				(nd.prototype.hide = function () {
			...
			var uo = sh(423),
				...
				od =
					'undefined' != typeof Map
						? Map
						: (Object.defineProperty(id.prototype, 'size', {
								get: function () {
							...
							(id.prototype.get = function (e) {
								(e = ad(this.__entries__, e)), (e = this.__entries__[e]);
								return e && e[1];
							}),
							(id.prototype.set = function (e, t) {
								var n = ad(this.__entries__, e);
								~n ? (this.__entries__[n][1] = t) : this.__entries__.push([e, t]);
							}),
							(id.prototype.delete = function (e) {
								var t = this.__entries__,
									e = ad(t, e);
								~e && t.splice(e, 1);
							}),
							(id.prototype.has = function (e) {
								return !!~ad(this.__entries__, e);
							}),
							(id.prototype.clear = function () {
								this.__entries__.splice(0);
							}),
							(id.prototype.forEach = function (e, t) {
								void 0 === t && (t = null);
			...
			var sd =
				...
				ud = 2;
			var pd = ['top', 'right', 'bottom', 'left', 'width', 'height', 'size', 'weight'],
				dd = 'undefined' != typeof MutationObserver,
				fd =
					((hd.prototype.addObserver = function (e) {
						~this.observers_.indexOf(e) || this.observers_.push(e),
							this.connected_ || this.connect_();
					}),
					(hd.prototype.removeObserver = function (e) {
						var t = this.observers_,
							e = t.indexOf(e);
						~e && t.splice(e, 1), !t.length && this.connected_ && this.disconnect_();
					}),
					(hd.prototype.refresh = function () {
						this.updateObservers_() && this.refresh();
					}),
					(hd.prototype.updateObservers_ = function () {
					...
					(hd.prototype.connect_ = function () {
						sd &&
							!this.connected_ &&
					...
					(hd.prototype.disconnect_ = function () {
						sd &&
							this.connected_ &&
					...
					(hd.prototype.onTransitionEnd_ = function (e) {
					...
					(hd.getInstance = function () {
						return this.instance_ || (this.instance_ = new hd()), this.instance_;
					}),
					(hd.instance_ = null),
					hd);
			function hd() {
			...
			var md = function (e, t) {
				...
				gd = function (e) {
					return (e && e.ownerDocument && e.ownerDocument.defaultView) || ld;
				},
				vd = Cd(0, 0, 0, 0);
			function yd(e) {
				...
				return s || l
					? ((n =
							(t = (function (e) {
								...
								return t;
							})((a = gd(e).getComputedStyle(e)))).left + t.right),
						(r = t.top + t.bottom),
						(o = yd(a.width)),
						(i = yd(a.height)),
						'border-box' === a.boxSizing &&
							(Math.round(o + n) !== s && (o -= bd(a, 'left', 'right') + n),
							Math.round(i + r) !== l) &&
							(i -= bd(a, 'top', 'bottom') + r),
						e !== gd(e).document.documentElement &&
							((a = Math.round(o + n) - s),
							(e = Math.round(i + r) - l),
							1 !== Math.abs(a) && (o -= a),
							1 !== Math.abs(e)) &&
			...
			var kd =
				'undefined' != typeof SVGGraphicsElement
					? function (e) {
							return e instanceof gd(e).SVGGraphicsElement;
						}
					: function (e) {
							return e instanceof gd(e).SVGElement && 'function' == typeof e.getBBox;
						};
			function xd(e) {
				var t;
				return sd ? (kd(e) ? Cd(0, 0, (t = (t = e).getBBox()).width, t.height) : wd(e)) : vd;
			}
			function Cd(e, t, n, r) {
				return { x: e, y: t, width: n, height: r };
			}
			(Ed.prototype.isActive = function () {
				var e = xd(this.target);
				return (
					(this.contentRect_ = e).width !== this.broadcastWidth || e.height !== this.broadcastHeight
				);
			}),
				(Ed.prototype.broadcastRect = function () {
			...
			var Md = function (e, t) {
					...
					var n,
						...
						o,
						i = o;
					md(this, { target: e, contentRect: i });
				},
				Ld =
					((Nd.prototype.observe = function (e) {
						if (!arguments.length) throw new TypeError('1 argument required, but only 0 present.');
						if ('undefined' != typeof Element && Element instanceof Object) {
							if (!(e instanceof gd(e).Element))
					...
					(Nd.prototype.unobserve = function (e) {
						if (!arguments.length) throw new TypeError('1 argument required, but only 0 present.');
						if ('undefined' != typeof Element && Element instanceof Object) {
							if (!(e instanceof gd(e).Element))
								throw new TypeError('parameter 1 is not of type "Element".');
					...
					(Nd.prototype.disconnect = function () {
						this.clearActive(), this.observations_.clear(), this.controller_.removeObserver(this);
					}),
					(Nd.prototype.gatherActive = function () {
						var t = this;
						this.clearActive(),
					...
					(Nd.prototype.broadcastActive = function () {
						var e, t;
						this.hasActive() &&
							((e = this.callbackCtx_),
					...
					(Nd.prototype.clearActive = function () {
						this.activeObservations_.splice(0);
					}),
					(Nd.prototype.hasActive = function () {
						return 0 < this.activeObservations_.length;
					}),
					Nd);
			function Nd(e, t, n) {
				if (
					((this.activeObservations_ = []), (this.observations_ = new od()), 'function' != typeof e)
				)
					throw new TypeError('The callback provided as parameter 1 is not a function.');
				(this.callback_ = e), (this.controller_ = t), (this.callbackCtx_ = n);
			}
			var Sd = new ('undefined' != typeof WeakMap ? WeakMap : od)(),
				Ad = function e(t) {
					if (!(this instanceof e)) throw new TypeError('Cannot call a class as a function.');
					if (!arguments.length) throw new TypeError('1 argument required, but only 0 present.');
					var n = fd.getInstance(),
						t = new Ld(t, n, this);
					Sd.set(this, t);
				};
			['observe', 'unobserve', 'disconnect'].forEach(function (t) {
				Ad.prototype[t] = function () {
					var e;
					return (e = Sd.get(this))[t].apply(e, arguments);
				};
			});
			var Dd,
				Od,
				Id,
				Rd = void 0 !== ld.ResizeObserver ? ld.ResizeObserver : Ad,
				Pd =
					(r(Hd, (Dd = Qp)),
					(Hd.prototype.execCommand = function (e) {
						e = dt(e.target, 'li');
			...
			r(_d, (Bd = Qp)),
				(_d.prototype.toggleTab = function (e, t) {
			...
			r(Wd, (zd = Qp)),
				(Wd.prototype.emitAddImageBlob = function () {
					var n = this,
				...
				(Wd.prototype.emitAddImage = function () {
					var e = this.refs.url,
						t = this.refs.altText,
						n = e.value,
						t = t.value || 'image';
				...
				(Wd.prototype.preventSelectStart = function (e) {
					e.preventDefault();
				}),
				(Wd.prototype.updated = function () {
				...
				(Wd.prototype.render = function () {
					...
					return O(
						...
						'file' === n ? 'block' : 'none',
						M.get('Select image file'),
						d('file-name'),
						r ? ' has-file' : e,
						this.showFileSelectBox,
						this.preventSelectStart,
						r ? r.name : M.get('No file'),
			...
			r(Xd, ($d = Qp)),
				...
				(Xd.prototype.updated = function (e) {
			...
			r(nf, (Kd = Qp)),
				(nf.prototype.getDescription = function () {
					return -1 === this.state.colIdx
						? ''
						: this.state.colIdx + 1 + ' x ' + (this.state.rowIdx + 1);
				}),
				(nf.prototype.getBoundByRange = function (e, t) {
					return { width: 20 * (e + 1), height: 20 * (t + 1) };
				}),
				(nf.prototype.getRangeByOffset = function (e, t) {
					return { colIdx: Math.floor(e / 20), rowIdx: Math.floor(t / 20) };
				}),
				(nf.prototype.getTableRange = function () {
					var e = this.state,
						t = e.colIdx,
						e = e.rowIdx,
						n = Math.max(t, 5),
				...
				(nf.prototype.createTableArea = function (e) {
					...
					return O(
						(Jd = Jd || p(['<div class="', '">', '</div>'], ['<div class="', '">', '</div>'])),
						d('table'),
						r
					);
				}),
				(nf.prototype.render = function () {
					var t = this,
			...
			var rf,
				...
				pf = df;
			function df() {
				return (null !== rf && rf.apply(this, arguments)) || this;
			}
			function ff(e) {
				if (j()(e)) {
					var t;
					switch (e) {
						...
						case 'table':
							t = {
								name: 'table',
								className: 'table',
								tooltip: M.get('Insert table'),
								state: 'table'
							};
							break;
						case 'image':
							t = { name: 'image', className: 'image', tooltip: M.get('Insert image') };
							break;
						case 'link':
							t = { name: 'link', className: 'link', tooltip: M.get('Insert link') };
							break;
						case 'code':
							t = {
								name: 'code',
						...
						case 'codeblock':
							t = {
								...
								className: 'codeblock',
								command: 'codeBlock',
								tooltip: M.get('Insert CodeBlock'),
								state: 'codeBlock'
							};
							break;
						case 'indent':
						...
						case 'scrollSync':
							...
							break;
						case 'more':
							t = { name: 'more', className: 'more', tooltip: M.get('More') };
					}
			...
			function gf(e, n) {
				return e.reduce(function (e, t) {
					e.push(
						t.map(function (e) {
							return ((e = ff(e)).hidden = 'scrollSync' === e.name && n), e;
						})
					);
					t = e[(e.length || 1) - 1];
					return t && mf(t), e;
			...
			r(wf, (vf = Qp)),
				(wf.prototype.mounted = function () {
					document.addEventListener('mousedown', this.handleMousedown),
						this.props.eventEmitter.listen('closePopup', this.props.hidePopup);
				}),
				(wf.prototype.beforeDestroy = function () {
					document.removeEventListener('mousedown', this.handleMousedown);
				}),
				(wf.prototype.updated = function (e) {
					var t = this.props,
						n = t.show,
						t = t.info;
					n &&
			...
			var vf,
				...
				bf = wf;
			function wf() {
				var t = (null !== vf && vf.apply(this, arguments)) || this;
				return (
					...
					return (
						(r.showTooltip = function (e) {
							...
							!r.props.disabled &&
								...
								(e = e.top + 6 + 'px'),
								B()(r.props.tooltipRef.current, { display: 'block', left: t, top: e }),
								(r.props.tooltipRef.current.querySelector('.text').textContent = n));
						}),
						(r.hideTooltip = function () {
							B()(r.props.tooltipRef.current, 'display', 'none');
						}),
			...
			var Cf;
			function Tf() {
				var s = (null !== Cf && Cf.apply(this, arguments)) || this;
				return (
					...
					(s.execCommand = function () {
						...
						i
							...
							: ((i = e.emit('query', 'getPopupInitialValues', {
								...
								(e = hf(n, { el: s.refs.el, pos: o(s.refs.el), popup: t, initialValues: i })) &&
									r(e));
					}),
					s
				);
			...
			r(Tf, (Cf = Qp)),
				(Tf.prototype.mounted = function () {
					this.setItemWidth();
				}),
				(Tf.prototype.updated = function (e) {
					e.item.name !== this.props.item.name && this.setItemWidth();
				}),
				(Tf.prototype.setItemWidth = function () {
					var e = this.props,
						t = e.setItemWidth,
						e = e.item;
			...
			r(Nf, (Mf = Qp)),
				...
				(Nf.prototype.updated = function (e) {
					var t = this.props,
						n = t.item,
						r = t.active,
						t = t.disabled;
			...
			var Ff,
				...
				Vf =
					(r(Wf, (jf = Qp)),
					(Wf.prototype.insertToolbarItem = function (e, t) {
						var n = e.groupIndex,
							e = e.itemIndex,
					...
					(Wf.prototype.removeToolbarItem = function (o) {
						var i = this;
					...
					(Wf.prototype.hiddenScrollSync = function () {
						return 'wysiwyg' === this.props.editorType || 'tab' === this.props.previewStyle;
					}),
					(Wf.prototype.movePrevItemToDropdownToolbar = function (e, t, n, r) {
						function o(e) {
							(e = e.pop()) && r.push(e);
						}
						1 < e ? o(n) : (e = K(t)) && o(e);
					}),
					(Wf.prototype.classifyToolbarItems = function () {
						var o = this,
							i = 0,
						...
						return (
							this.initialItems.forEach(function (e, t) {
								...
								e.forEach(function (e, t) {
									...
									n.length && (mf(n), l.push(n)),
									r.length && (mf(r), c.push(r)),
			...
			function Wf(e) {
				...
				return (
					...
					(i.itemWidthMap = {}),
					(i.initialItems = gf(e.toolbarItems || [], i.hiddenScrollSync())),
					(i.state = {
					...
					(i.resizeObserver = new Rd(function () {
			...
			r(Qf, ($f = Qp)),
				(Qf.prototype.addEvent = function () {
					var n = this;
				...
				(Qf.prototype.mounted = function () {
					document.addEventListener('click', this.handleClickDocument);
				}),
				(Qf.prototype.beforeDestroy = function () {
					document.removeEventListener('click', this.handleClickDocument);
				}),
				(Qf.prototype.getMenuGroupElements = function () {
					var a = this,
						e = this.state,
						t = e.pos,
						e = e.menuGroups;
			...
			r(rh, (Yf = Qp)),
				...
				(rh.prototype.addEvent = function () {
			...
			r(oh, (th = a)),
				(oh.factory = function (e) {
					return new (e.viewer ? kp : oh)(e);
				}),
				(oh.prototype.insertToolbarItem = function (e, t) {
					this.defaultUI.insertToolbarItem(e, t);
				}),
				(oh.prototype.removeToolbarItem = function (e) {
					this.defaultUI.removeToolbarItem(e);
				}),
				(oh.prototype.destroy = function () {
					th.prototype.destroy.call(this), this.defaultUI.destroy();
				});
			var ih,
				lo = oh,
				ah =
	...
	function sh(e) {
		var t = u[e];
		return (
			void 0 !== t || ((t = u[e] = { exports: {} }), c[e].call(t.exports, t, t.exports, sh)),
			t.exports
		);
	}
	var c, u, lh;
