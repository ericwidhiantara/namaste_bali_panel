				...
				<div class="col-xl-4 col-lg-4">
					...
					<div class="d-flex align-items-start">
						...
						<div class="ms-3">
							...
							<p class="mb-0 mt-xl-4 mt-3 text-muted small">
								"Power up your web app with our sleek (Bvite) Bootstrap admin dashboard template.
							</p>
						</div>
					</div>
				</div>
			...
			<div class="card">
				...
				<div class="card-body custom_scroll" style="height: 280px;">
					<div class="d-flex align-items-center">
						<div class="avatar rounded-circle no-thumbnail theme-color4 text-white">
